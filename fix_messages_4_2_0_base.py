...
class BeginString (fix_core_fields.BeginString) :
    _tag = '8'

class BodyLength (fix_core_fields.BodyLength) :
    _tag = '9'

class CheckSum (fix_core_fields.CheckSum) :
    _tag = '10'
...
class MsgType (fix_core_fields.MsgType) :
    _tag = '35'
    ENUM_HEARTBEAT = '0'
    ENUM_TEST_REQUEST = '1'
...
class Header(fix_message.MessageBase):
    def __init__(self):
        ...
        self.register_group(NoHops, Header.NoHopsGroup, False)
...
class IOI(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoSecurityAltID, IOI.NoSecurityAltIDGroup, False)
        ...
        self.register_group(NoEvents, IOI.NoEventsGroup, False)
        ...
        self.register_group(NoUnderlyings, IOI.NoUnderlyingsGroup, False)
        ...
        self.register_group(NoStipulations, IOI.NoStipulationsGroup, False)

        self.register_group(NoLegs, IOI.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoUnderlyingSecurityAltID, IOI.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_group(NoUnderlyingStips, IOI.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoLegSecurityAltID, IOI.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_group(NoLegStipulations, IOI.NoLegsGroup.NoLegStipulationsGroup, False)
...
class Advertisement(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, Advertisement.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, Advertisement.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoLegs, Advertisement.NoLegsGroup, False)

        self.register_group(NoUnderlyings, Advertisement.NoUnderlyingsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, Advertisement.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, Advertisement.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, Advertisement.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class ExecutionReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, ExecutionReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, ExecutionReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, ExecutionReport.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, ExecutionReport.NoUnderlyingsGroup, False)

        self.register_field(Side, True)
        self.register_group(NoStipulations, ExecutionReport.NoStipulationsGroup, False)
        ...
        self.register_group(NoContAmts, ExecutionReport.NoContAmtsGroup, False)

        self.register_group(NoLegs, ExecutionReport.NoLegsGroup, False)

        self.register_field(CopyMsgIndicator, False)
        self.register_group(NoMiscFees, ExecutionReport.NoMiscFeesGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoPartySubIDs, ExecutionReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, ExecutionReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, ExecutionReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, ExecutionReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_group(NoLegStipulations, ExecutionReport.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_field(LegPositionEffect, False)
            self.register_field(LegCoveredOrUncovered, False)
            self.register_group(NoNestedPartyIDs, ExecutionReport.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_group(NoNestedPartySubIDs, ExecutionReport.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class News(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoLegs, News.NoLegsGroup, False)

        self.register_group(NoUnderlyings, News.NoUnderlyingsGroup, False)

        self.register_group(NoLinesOfText, News.NoLinesOfTextGroup, True)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, News.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, News.NoRelatedSymGroup.NoEventsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, News.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, News.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, News.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class Email(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoUnderlyings, Email.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, Email.NoLegsGroup, False)

        self.register_field(OrderID, False)
        self.register_field(ClOrdID, False)
        self.register_group(NoLinesOfText, Email.NoLinesOfTextGroup, True)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, Email.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, Email.NoRelatedSymGroup.NoEventsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, Email.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, Email.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, Email.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class NewOrderSingle(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecondaryClOrdID, False)
        self.register_field(ClOrdLinkID, False)
        self.register_group(NoPartyIDs, NewOrderSingle.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, NewOrderSingle.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, NewOrderSingle.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, NewOrderSingle.NoUnderlyingsGroup, False)

        self.register_field(PrevClosePx, False)
        self.register_field(Side, True)
        self.register_field(LocateReqd, False)
        self.register_field(TransactTime, True)
        self.register_group(NoStipulations, NewOrderSingle.NoStipulationsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, NewOrderSingle.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoNestedPartyIDs, NewOrderSingle.NoAllocsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, NewOrderSingle.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, NewOrderSingle.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, NewOrderSingle.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class NewOrderList(fix_message.MessageBase):
    ...
    class NoOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoPartyIDs, NewOrderList.NoOrdersGroup.NoPartyIDsGroup, False)
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, NewOrderList.NoOrdersGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, NewOrderList.NoOrdersGroup.NoEventsGroup, False)

            self.register_field(DatedDate, False)
            self.register_field(InterestAccrualDate, False)
            self.register_group(NoUnderlyings, NewOrderList.NoOrdersGroup.NoUnderlyingsGroup, False)
            ...
            self.register_field(LocateReqd, False)
            self.register_field(TransactTime, False)
            self.register_group(NoStipulations, NewOrderList.NoOrdersGroup.NoStipulationsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, NewOrderList.NoOrdersGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
        ...
        class NoAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(AllocSettlCurrency, False)
                self.register_field(IndividualAllocID, False)
                self.register_group(NoNestedPartyIDs, NewOrderList.NoOrdersGroup.NoAllocsGroup.NoNestedPartyIDsGroup, False)
            ...
            class NoNestedPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(NestedPartyIDSource, False)
                    self.register_field(NestedPartyRole, False)
                    self.register_group(NoNestedPartySubIDs, NewOrderList.NoOrdersGroup.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, NewOrderList.NoOrdersGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, NewOrderList.NoOrdersGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class OrderCancelRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(AcctIDSource, False)
        self.register_field(AccountType, False)
        self.register_group(NoPartyIDs, OrderCancelRequest.NoPartyIDsGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderCancelRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderCancelRequest.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, OrderCancelRequest.NoUnderlyingsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, OrderCancelRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, OrderCancelRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, OrderCancelRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class OrderCancelReplaceRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(OrderID, False)
        self.register_group(NoPartyIDs, OrderCancelReplaceRequest.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderCancelReplaceRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderCancelReplaceRequest.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, OrderCancelReplaceRequest.NoUnderlyingsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, OrderCancelReplaceRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(AllocSettlCurrency, False)
            self.register_field(IndividualAllocID, False)
            self.register_group(NoNestedPartyIDs, OrderCancelReplaceRequest.NoAllocsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, OrderCancelReplaceRequest.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, OrderCancelReplaceRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, OrderCancelReplaceRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class OrderStatusRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecondaryClOrdID, False)
        self.register_field(ClOrdLinkID, False)
        self.register_group(NoPartyIDs, OrderStatusRequest.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderStatusRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderStatusRequest.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, OrderStatusRequest.NoUnderlyingsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, OrderStatusRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, OrderStatusRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, OrderStatusRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class AllocationInstruction(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoOrders, AllocationInstruction.NoOrdersGroup, False)

        self.register_group(NoExecs, AllocationInstruction.NoExecsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, AllocationInstruction.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, AllocationInstruction.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, AllocationInstruction.NoInstrAttribGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, AllocationInstruction.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, AllocationInstruction.NoLegsGroup, False)
        ...
        self.register_group(NoPartyIDs, AllocationInstruction.NoPartyIDsGroup, False)
        ...
        self.register_group(NoStipulations, AllocationInstruction.NoStipulationsGroup, False)
        ...
        self.register_field(LastFragment, False)
        self.register_group(NoAllocs, AllocationInstruction.NoAllocsGroup, False)
    ...
    class NoOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ListID, False)
            self.register_group(NoNested2PartyIDs, AllocationInstruction.NoOrdersGroup.NoNested2PartyIDsGroup, False)
        ...
        class NoNested2PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_group(NoNested2PartySubIDs, AllocationInstruction.NoOrdersGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, AllocationInstruction.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, AllocationInstruction.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, AllocationInstruction.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, AllocationInstruction.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(IndividualAllocID, False)
            self.register_field(ProcessCode, False)
            self.register_group(NoNestedPartyIDs, AllocationInstruction.NoAllocsGroup.NoNestedPartyIDsGroup, False)
            ...
            self.register_group(NoMiscFees, AllocationInstruction.NoAllocsGroup.NoMiscFeesGroup, False)

            self.register_group(NoClearingInstructions, AllocationInstruction.NoAllocsGroup.NoClearingInstructionsGroup, False)
            ...
            self.register_group(NoDlvyInst, AllocationInstruction.NoAllocsGroup.NoDlvyInstGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, AllocationInstruction.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
        ...
        class NoDlvyInstGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_group(NoSettlPartyIDs, AllocationInstruction.NoAllocsGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
            ...
            class NoSettlPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_group(NoSettlPartySubIDs, AllocationInstruction.NoAllocsGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class AllocationInstructionAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(AllocID, True)
        self.register_group(NoPartyIDs, AllocationInstructionAck.NoPartyIDsGroup, False)
        ...
        self.register_field(EncodedTextLen, False)
        self.register_field(EncodedText, False)
        self.register_group(NoAllocs, AllocationInstructionAck.NoAllocsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, AllocationInstructionAck.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class DontKnowTrade(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, DontKnowTrade.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, DontKnowTrade.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, DontKnowTrade.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, DontKnowTrade.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, DontKnowTrade.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, DontKnowTrade.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, DontKnowTrade.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class QuoteRequest(fix_message.MessageBase):
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, QuoteRequest.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, QuoteRequest.NoRelatedSymGroup.NoEventsGroup, False)
            ...
            self.register_field(DeliveryType, False)
            self.register_field(MarginRatio, False)
            self.register_group(NoUnderlyings, QuoteRequest.NoRelatedSymGroup.NoUnderlyingsGroup, False)
            ...
            self.register_field(OrderQty2, False)
            self.register_field(Currency, False)
            self.register_group(NoStipulations, QuoteRequest.NoRelatedSymGroup.NoStipulationsGroup, False)

            self.register_field(Account, False)
            self.register_field(AcctIDSource, False)
            self.register_field(AccountType, False)
            self.register_group(NoLegs, QuoteRequest.NoRelatedSymGroup.NoLegsGroup, False)

            self.register_group(NoQuoteQualifiers, QuoteRequest.NoRelatedSymGroup.NoQuoteQualifiersGroup, False)
            ...
            self.register_field(YieldRedemptionPrice, False)
            self.register_field(YieldRedemptionPriceType, False)
            self.register_group(NoPartyIDs, QuoteRequest.NoRelatedSymGroup.NoPartyIDsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, QuoteRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, QuoteRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, QuoteRequest.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
                ...
                self.register_field(LegSettlType, False)
                self.register_field(LegSettlDate, False)
                self.register_group(NoLegStipulations, QuoteRequest.NoRelatedSymGroup.NoLegsGroup.NoLegStipulationsGroup, False)

                self.register_group(NoNestedPartyIDs, QuoteRequest.NoRelatedSymGroup.NoLegsGroup.NoNestedPartyIDsGroup, False)
            ...
            class NoNestedPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(NestedPartyIDSource, False)
                    self.register_field(NestedPartyRole, False)
                    self.register_group(NoNestedPartySubIDs, QuoteRequest.NoRelatedSymGroup.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, QuoteRequest.NoRelatedSymGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class Quote(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(QuoteRespID, False)
        self.register_field(QuoteType, False)
        self.register_group(NoQuoteQualifiers, Quote.NoQuoteQualifiersGroup, False)

        self.register_field(QuoteResponseLevel, False)
        self.register_group(NoPartyIDs, Quote.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, Quote.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, Quote.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, Quote.NoUnderlyingsGroup, False)
        ...
        self.register_field(OrderQty2, False)
        self.register_field(Currency, False)
        self.register_group(NoStipulations, Quote.NoStipulationsGroup, False)

        self.register_field(Account, False)
        self.register_field(AcctIDSource, False)
        self.register_field(AccountType, False)
        self.register_group(NoLegs, Quote.NoLegsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, Quote.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, Quote.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, Quote.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, Quote.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegSettlType, False)
            self.register_field(LegSettlDate, False)
            self.register_group(NoLegStipulations, Quote.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_group(NoNestedPartyIDs, Quote.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, Quote.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class SettlementInstructions(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(ClOrdID, False)
        self.register_field(TransactTime, True)
        self.register_group(NoSettlInst, SettlementInstructions.NoSettlInstGroup, False)
    ...
    class NoSettlInstGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoPartyIDs, SettlementInstructions.NoSettlInstGroup.NoPartyIDsGroup, False)
            ...
            self.register_field(StandInstDbName, False)
            self.register_field(StandInstDbID, False)
            self.register_group(NoDlvyInst, SettlementInstructions.NoSettlInstGroup.NoDlvyInstGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, SettlementInstructions.NoSettlInstGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
        ...
        class NoDlvyInstGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlInstSource, False)
                self.register_field(DlvyInstType, False)
                self.register_group(NoSettlPartyIDs, SettlementInstructions.NoSettlInstGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
            ...
            class NoSettlPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(SettlPartyIDSource, False)
                    self.register_field(SettlPartyRole, False)
                    self.register_group(NoSettlPartySubIDs, SettlementInstructions.NoSettlInstGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class MarketDataRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoTradingSessions, MarketDataRequest.NoTradingSessionsGroup, False)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, MarketDataRequest.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, MarketDataRequest.NoRelatedSymGroup.NoEventsGroup, False)

            self.register_field(DatedDate, False)
            self.register_field(InterestAccrualDate, False)
            self.register_group(NoUnderlyings, MarketDataRequest.NoRelatedSymGroup.NoUnderlyingsGroup, False)

            self.register_group(NoLegs, MarketDataRequest.NoRelatedSymGroup.NoLegsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, MarketDataRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, MarketDataRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, MarketDataRequest.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class MarketDataSnapshotFullRefresh(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, MarketDataSnapshotFullRefresh.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, MarketDataSnapshotFullRefresh.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, MarketDataSnapshotFullRefresh.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, MarketDataSnapshotFullRefresh.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, MarketDataSnapshotFullRefresh.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, MarketDataSnapshotFullRefresh.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, MarketDataSnapshotFullRefresh.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class MarketDataIncrementalRefresh(fix_message.MessageBase):
    ...
    class NoMDEntriesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoEventsGroup, False)

            self.register_field(DatedDate, False)
            self.register_field(InterestAccrualDate, False)
            self.register_group(NoUnderlyings, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoUnderlyingsGroup, False)

            self.register_group(NoLegs, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoLegsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, MarketDataIncrementalRefresh.NoMDEntriesGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class MarketDataRequestReject(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoAltMDSource, MarketDataRequestReject.NoAltMDSourceGroup, False)
...
class QuoteCancel(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(QuoteResponseLevel, False)
        self.register_group(NoPartyIDs, QuoteCancel.NoPartyIDsGroup, False)
        ...
        self.register_field(TradingSessionID, False)
        self.register_field(TradingSessionSubID, False)
        self.register_group(NoQuoteEntries, QuoteCancel.NoQuoteEntriesGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, QuoteCancel.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoQuoteEntriesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, QuoteCancel.NoQuoteEntriesGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, QuoteCancel.NoQuoteEntriesGroup.NoEventsGroup, False)
            ...
            self.register_field(DeliveryType, False)
            self.register_field(MarginRatio, False)
            self.register_group(NoUnderlyings, QuoteCancel.NoQuoteEntriesGroup.NoUnderlyingsGroup, False)

            self.register_group(NoLegs, QuoteCancel.NoQuoteEntriesGroup.NoLegsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, QuoteCancel.NoQuoteEntriesGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, QuoteCancel.NoQuoteEntriesGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, QuoteCancel.NoQuoteEntriesGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class QuoteStatusRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, QuoteStatusRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, QuoteStatusRequest.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, QuoteStatusRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, QuoteStatusRequest.NoLegsGroup, False)

        self.register_group(NoPartyIDs, QuoteStatusRequest.NoPartyIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, QuoteStatusRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, QuoteStatusRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, QuoteStatusRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, QuoteStatusRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class MassQuoteAcknowledgement(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(QuoteResponseLevel, False)
        self.register_field(QuoteType, False)
        self.register_group(NoPartyIDs, MassQuoteAcknowledgement.NoPartyIDsGroup, False)
        ...
        self.register_field(EncodedTextLen, False)
        self.register_field(EncodedText, False)
        self.register_group(NoQuoteSets, MassQuoteAcknowledgement.NoQuoteSetsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, MassQuoteAcknowledgement.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoQuoteSetsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoUnderlyingStipsGroup, False)

            self.register_field(TotNoQuoteEntries, False)
            self.register_field(LastFragment, False)
            self.register_group(NoQuoteEntries, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoQuoteEntriesGroup, False)
        ...
        class NoQuoteEntriesGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SecurityID, False)
                self.register_field(SecurityIDSource, False)
                self.register_group(NoSecurityAltID, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoSecurityAltIDGroup, False)
                ...
                self.register_field(CPProgram, False)
                self.register_field(CPRegType, False)
                self.register_group(NoEvents, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoEventsGroup, False)

                self.register_field(DatedDate, False)
                self.register_field(InterestAccrualDate, False)
                self.register_group(NoLegs, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoLegsGroup, False)
            ...
            class NoLegsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(LegSecurityID, False)
                    self.register_field(LegSecurityIDSource, False)
                    self.register_group(NoLegSecurityAltID, MassQuoteAcknowledgement.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityDefinitionRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, SecurityDefinitionRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, SecurityDefinitionRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, SecurityDefinitionRequest.NoInstrAttribGroup, False)

        self.register_group(NoUnderlyings, SecurityDefinitionRequest.NoUnderlyingsGroup, False)
        ...
        self.register_field(TradingSessionID, False)
        self.register_field(TradingSessionSubID, False)
        self.register_group(NoLegs, SecurityDefinitionRequest.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, SecurityDefinitionRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, SecurityDefinitionRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, SecurityDefinitionRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityDefinition(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, SecurityDefinition.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, SecurityDefinition.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, SecurityDefinition.NoInstrAttribGroup, False)

        self.register_group(NoUnderlyings, SecurityDefinition.NoUnderlyingsGroup, False)
        ...
        self.register_field(EncodedTextLen, False)
        self.register_field(EncodedText, False)
        self.register_group(NoLegs, SecurityDefinition.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, SecurityDefinition.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, SecurityDefinition.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, SecurityDefinition.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityStatusRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, SecurityStatusRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, SecurityStatusRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, SecurityStatusRequest.NoInstrAttribGroup, False)

        self.register_group(NoUnderlyings, SecurityStatusRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, SecurityStatusRequest.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, SecurityStatusRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, SecurityStatusRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, SecurityStatusRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityStatus(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, SecurityStatus.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, SecurityStatus.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, SecurityStatus.NoInstrAttribGroup, False)

        self.register_group(NoUnderlyings, SecurityStatus.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, SecurityStatus.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, SecurityStatus.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, SecurityStatus.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, SecurityStatus.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class MassQuote(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(QuoteType, False)
        self.register_field(QuoteResponseLevel, False)
        self.register_group(NoPartyIDs, MassQuote.NoPartyIDsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, MassQuote.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoQuoteSetsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, MassQuote.NoQuoteSetsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, MassQuote.NoQuoteSetsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoQuoteEntriesGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SecurityID, False)
                self.register_field(SecurityIDSource, False)
                self.register_group(NoSecurityAltID, MassQuote.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoSecurityAltIDGroup, False)
                ...
                self.register_field(CPProgram, False)
                self.register_field(CPRegType, False)
                self.register_group(NoEvents, MassQuote.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoEventsGroup, False)

                self.register_field(DatedDate, False)
                self.register_field(InterestAccrualDate, False)
                self.register_group(NoLegs, MassQuote.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoLegsGroup, False)
            ...
            class NoLegsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(LegSecurityID, False)
                    self.register_field(LegSecurityIDSource, False)
                    self.register_group(NoLegSecurityAltID, MassQuote.NoQuoteSetsGroup.NoQuoteEntriesGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class ListStrikePrice(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoUnderlyings, ListStrikePrice.NoUnderlyingsGroup, False)
    ...
    class NoStrikesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, ListStrikePrice.NoStrikesGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, ListStrikePrice.NoStrikesGroup.NoEventsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, ListStrikePrice.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, ListStrikePrice.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class RegistrationInstructions(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(ClOrdID, False)
        self.register_group(NoPartyIDs, RegistrationInstructions.NoPartyIDsGroup, False)
        ...
        self.register_group(NoRegistDtls, RegistrationInstructions.NoRegistDtlsGroup, False)

        self.register_group(NoDistribInsts, RegistrationInstructions.NoDistribInstsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, RegistrationInstructions.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoRegistDtlsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoNestedPartyIDs, RegistrationInstructions.NoRegistDtlsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, RegistrationInstructions.NoRegistDtlsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class RegistrationInstructionsResponse(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(RegistRefID, True)
        self.register_field(ClOrdID, False)
        self.register_group(NoPartyIDs, RegistrationInstructionsResponse.NoPartyIDsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, RegistrationInstructionsResponse.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class OrderMassCancelRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderMassCancelRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderMassCancelRequest.NoEventsGroup, False)
        ...
        self.register_field(UnderlyingSecurityID, False)
        self.register_field(UnderlyingSecurityIDSource, False)
        self.register_group(NoUnderlyingSecurityAltID, OrderMassCancelRequest.NoUnderlyingSecurityAltIDGroup, False)
        ...
        self.register_field(UnderlyingCurrentValue, False)
        self.register_field(UnderlyingEndValue, False)
        self.register_group(NoUnderlyingStips, OrderMassCancelRequest.NoUnderlyingStipsGroup, False)
...
class OrderMassCancelReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoAffectedOrders, OrderMassCancelReport.NoAffectedOrdersGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderMassCancelReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderMassCancelReport.NoEventsGroup, False)
        ...
        self.register_field(UnderlyingSecurityID, False)
        self.register_field(UnderlyingSecurityIDSource, False)
        self.register_group(NoUnderlyingSecurityAltID, OrderMassCancelReport.NoUnderlyingSecurityAltIDGroup, False)
        ...
        self.register_field(UnderlyingCurrentValue, False)
        self.register_field(UnderlyingEndValue, False)
        self.register_group(NoUnderlyingStips, OrderMassCancelReport.NoUnderlyingStipsGroup, False)
...
class NewOrderCross(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoSides, NewOrderCross.NoSidesGroup, True)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, NewOrderCross.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, NewOrderCross.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, NewOrderCross.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, NewOrderCross.NoLegsGroup, False)
        ...
        self.register_field(MaxFloor, False)
        self.register_field(ExDestination, False)
        self.register_group(NoTradingSessions, NewOrderCross.NoTradingSessionsGroup, False)

        self.register_field(ProcessCode, False)
        self.register_field(PrevClosePx, False)
        self.register_field(LocateReqd, False)
        self.register_field(TransactTime, True)
        self.register_group(NoStipulations, NewOrderCross.NoStipulationsGroup, False)
    ...
    class NoSidesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ClOrdLinkID, False)
            self.register_group(NoPartyIDs, NewOrderCross.NoSidesGroup.NoPartyIDsGroup, False)
            ...
            self.register_field(PreallocMethod, False)
            self.register_field(AllocID, False)
            self.register_group(NoAllocs, NewOrderCross.NoSidesGroup.NoAllocsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, NewOrderCross.NoSidesGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
        ...
        class NoAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(AllocSettlCurrency, False)
                self.register_field(IndividualAllocID, False)
                self.register_group(NoNestedPartyIDs, NewOrderCross.NoSidesGroup.NoAllocsGroup.NoNestedPartyIDsGroup, False)
            ...
            class NoNestedPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(NestedPartyIDSource, False)
                    self.register_field(NestedPartyRole, False)
                    self.register_group(NoNestedPartySubIDs, NewOrderCross.NoSidesGroup.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, NewOrderCross.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, NewOrderCross.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, NewOrderCross.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class CrossOrderCancelReplaceRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(CrossType, True)
        self.register_field(CrossPrioritization, True)
        self.register_group(NoSides, CrossOrderCancelReplaceRequest.NoSidesGroup, True)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CrossOrderCancelReplaceRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CrossOrderCancelReplaceRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, CrossOrderCancelReplaceRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, CrossOrderCancelReplaceRequest.NoLegsGroup, False)
        ...
        self.register_field(MaxFloor, False)
        self.register_field(ExDestination, False)
        self.register_group(NoTradingSessions, CrossOrderCancelReplaceRequest.NoTradingSessionsGroup, False)

        self.register_field(ProcessCode, False)
        self.register_field(PrevClosePx, False)
        self.register_field(LocateReqd, False)
        self.register_field(TransactTime, True)
        self.register_group(NoStipulations, CrossOrderCancelReplaceRequest.NoStipulationsGroup, False)
    ...
    class NoSidesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ClOrdLinkID, False)
            self.register_group(NoPartyIDs, CrossOrderCancelReplaceRequest.NoSidesGroup.NoPartyIDsGroup, False)
            ...
            self.register_field(PreallocMethod, False)
            self.register_field(AllocID, False)
            self.register_group(NoAllocs, CrossOrderCancelReplaceRequest.NoSidesGroup.NoAllocsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, CrossOrderCancelReplaceRequest.NoSidesGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
        ...
        class NoAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(AllocSettlCurrency, False)
                self.register_field(IndividualAllocID, False)
                self.register_group(NoNestedPartyIDs, CrossOrderCancelReplaceRequest.NoSidesGroup.NoAllocsGroup.NoNestedPartyIDsGroup, False)
            ...
            class NoNestedPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(NestedPartyIDSource, False)
                    self.register_field(NestedPartyRole, False)
                    self.register_group(NoNestedPartySubIDs, CrossOrderCancelReplaceRequest.NoSidesGroup.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CrossOrderCancelReplaceRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CrossOrderCancelReplaceRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CrossOrderCancelReplaceRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class CrossOrderCancelRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(CrossType, True)
        self.register_field(CrossPrioritization, True)
        self.register_group(NoSides, CrossOrderCancelRequest.NoSidesGroup, True)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CrossOrderCancelRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CrossOrderCancelRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, CrossOrderCancelRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, CrossOrderCancelRequest.NoLegsGroup, False)
    ...
    class NoSidesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(ClOrdLinkID, False)
            self.register_field(OrigOrdModTime, False)
            self.register_group(NoPartyIDs, CrossOrderCancelRequest.NoSidesGroup.NoPartyIDsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, CrossOrderCancelRequest.NoSidesGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CrossOrderCancelRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CrossOrderCancelRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CrossOrderCancelRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityTypes(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(LastFragment, False)
        self.register_group(NoSecurityTypes, SecurityTypes.NoSecurityTypesGroup, False)
...
class SecurityListRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, SecurityListRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, SecurityListRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, SecurityListRequest.NoInstrAttribGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, SecurityListRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, SecurityListRequest.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, SecurityListRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, SecurityListRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, SecurityListRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class SecurityList(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(LastFragment, False)
        self.register_group(NoRelatedSym, SecurityList.NoRelatedSymGroup, False)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, SecurityList.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, SecurityList.NoRelatedSymGroup.NoEventsGroup, False)

            self.register_field(DatedDate, False)
            self.register_field(InterestAccrualDate, False)
            self.register_field(DeliveryForm, False)
            self.register_field(PctAtRisk, False)
            self.register_group(NoInstrAttrib, SecurityList.NoRelatedSymGroup.NoInstrAttribGroup, False)
            ...
            self.register_field(DeliveryType, False)
            self.register_field(MarginRatio, False)
            self.register_group(NoUnderlyings, SecurityList.NoRelatedSymGroup.NoUnderlyingsGroup, False)

            self.register_field(Currency, False)
            self.register_group(NoStipulations, SecurityList.NoRelatedSymGroup.NoStipulationsGroup, False)

            self.register_group(NoLegs, SecurityList.NoRelatedSymGroup.NoLegsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, SecurityList.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, SecurityList.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, SecurityList.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
                ...
                self.register_field(LegSwapType, False)
                self.register_field(LegSettlType, False)
                self.register_group(NoLegStipulations, SecurityList.NoRelatedSymGroup.NoLegsGroup.NoLegStipulationsGroup, False)
...
class DerivativeSecurityListRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(UnderlyingSecurityID, False)
        self.register_field(UnderlyingSecurityIDSource, False)
        self.register_group(NoUnderlyingSecurityAltID, DerivativeSecurityListRequest.NoUnderlyingSecurityAltIDGroup, False)
        ...
        self.register_field(UnderlyingCurrentValue, False)
        self.register_field(UnderlyingEndValue, False)
        self.register_group(NoUnderlyingStips, DerivativeSecurityListRequest.NoUnderlyingStipsGroup, False)
...
class DerivativeSecurityList(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(UnderlyingSecurityID, False)
        self.register_field(UnderlyingSecurityIDSource, False)
        self.register_group(NoUnderlyingSecurityAltID, DerivativeSecurityList.NoUnderlyingSecurityAltIDGroup, False)
        ...
        self.register_field(UnderlyingCurrentValue, False)
        self.register_field(UnderlyingEndValue, False)
        self.register_group(NoUnderlyingStips, DerivativeSecurityList.NoUnderlyingStipsGroup, False)

        self.register_field(TotNoRelatedSym, False)
        self.register_field(LastFragment, False)
        self.register_group(NoRelatedSym, DerivativeSecurityList.NoRelatedSymGroup, False)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, DerivativeSecurityList.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, DerivativeSecurityList.NoRelatedSymGroup.NoEventsGroup, False)
            ...
            self.register_field(DeliveryForm, False)
            self.register_field(PctAtRisk, False)
            self.register_group(NoInstrAttrib, DerivativeSecurityList.NoRelatedSymGroup.NoInstrAttribGroup, False)

            self.register_group(NoLegs, DerivativeSecurityList.NoRelatedSymGroup.NoLegsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, DerivativeSecurityList.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class NewOrderMultileg(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecondaryClOrdID, False)
        self.register_field(ClOrdLinkID, False)
        self.register_group(NoPartyIDs, NewOrderMultileg.NoPartyIDsGroup, False)
        ...
        self.register_field(PreallocMethod, False)
        self.register_field(AllocID, False)
        self.register_group(NoAllocs, NewOrderMultileg.NoAllocsGroup, False)
        ...
        self.register_field(MaxFloor, False)
        self.register_field(ExDestination, False)
        self.register_group(NoTradingSessions, NewOrderMultileg.NoTradingSessionsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, NewOrderMultileg.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, NewOrderMultileg.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, NewOrderMultileg.NoUnderlyingsGroup, False)

        self.register_field(PrevClosePx, False)
        self.register_group(NoLegs, NewOrderMultileg.NoLegsGroup, True)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, NewOrderMultileg.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(AllocSettlCurrency, False)
            self.register_field(IndividualAllocID, False)
            self.register_group(NoNested3PartyIDs, NewOrderMultileg.NoAllocsGroup.NoNested3PartyIDsGroup, False)
        ...
        class NoNested3PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_group(NoNested3PartySubIDs, NewOrderMultileg.NoAllocsGroup.NoNested3PartyIDsGroup.NoNested3PartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, NewOrderMultileg.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, NewOrderMultileg.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, NewOrderMultileg.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegQty, False)
            self.register_field(LegSwapType, False)
            self.register_group(NoLegStipulations, NewOrderMultileg.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_group(NoLegAllocs, NewOrderMultileg.NoLegsGroup.NoLegAllocsGroup, False)

            self.register_field(LegPositionEffect, False)
            self.register_field(LegCoveredOrUncovered, False)
            self.register_group(NoNestedPartyIDs, NewOrderMultileg.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoLegAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_group(NoNested2PartyIDs, NewOrderMultileg.NoLegsGroup.NoLegAllocsGroup.NoNested2PartyIDsGroup, False)
            ...
            class NoNested2PartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(Nested2PartyIDSource, False)
                    self.register_field(Nested2PartyRole, False)
                    self.register_group(NoNested2PartySubIDs, NewOrderMultileg.NoLegsGroup.NoLegAllocsGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, NewOrderMultileg.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class MultilegOrderCancelReplace(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(ClOrdLinkID, False)
        self.register_field(OrigOrdModTime, False)
        self.register_group(NoPartyIDs, MultilegOrderCancelReplace.NoPartyIDsGroup, False)
        ...
        self.register_field(PreallocMethod, False)
        self.register_field(AllocID, False)
        self.register_group(NoAllocs, MultilegOrderCancelReplace.NoAllocsGroup, False)
        ...
        self.register_field(MaxFloor, False)
        self.register_field(ExDestination, False)
        self.register_group(NoTradingSessions, MultilegOrderCancelReplace.NoTradingSessionsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, MultilegOrderCancelReplace.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, MultilegOrderCancelReplace.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, MultilegOrderCancelReplace.NoUnderlyingsGroup, False)

        self.register_field(PrevClosePx, False)
        self.register_group(NoLegs, MultilegOrderCancelReplace.NoLegsGroup, True)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, MultilegOrderCancelReplace.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(AllocSettlCurrency, False)
            self.register_field(IndividualAllocID, False)
            self.register_group(NoNested3PartyIDs, MultilegOrderCancelReplace.NoAllocsGroup.NoNested3PartyIDsGroup, False)
        ...
        class NoNested3PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(Nested3PartyIDSource, False)
                self.register_field(Nested3PartyRole, False)
                self.register_group(NoNested3PartySubIDs, MultilegOrderCancelReplace.NoAllocsGroup.NoNested3PartyIDsGroup.NoNested3PartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, MultilegOrderCancelReplace.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, MultilegOrderCancelReplace.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, MultilegOrderCancelReplace.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegQty, False)
            self.register_field(LegSwapType, False)
            self.register_group(NoLegStipulations, MultilegOrderCancelReplace.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_group(NoLegAllocs, MultilegOrderCancelReplace.NoLegsGroup.NoLegAllocsGroup, False)

            self.register_field(LegPositionEffect, False)
            self.register_field(LegCoveredOrUncovered, False)
            self.register_group(NoNestedPartyIDs, MultilegOrderCancelReplace.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoLegAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegAllocAccount, False)
                self.register_field(LegIndividualAllocID, False)
                self.register_group(NoNested2PartyIDs, MultilegOrderCancelReplace.NoLegsGroup.NoLegAllocsGroup.NoNested2PartyIDsGroup, False)
            ...
            class NoNested2PartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(Nested2PartyIDSource, False)
                    self.register_field(Nested2PartyRole, False)
                    self.register_group(NoNested2PartySubIDs, MultilegOrderCancelReplace.NoLegsGroup.NoLegAllocsGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, MultilegOrderCancelReplace.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class TradeCaptureReportRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, TradeCaptureReportRequest.NoPartyIDsGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, TradeCaptureReportRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, TradeCaptureReportRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, TradeCaptureReportRequest.NoInstrAttribGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, TradeCaptureReportRequest.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, TradeCaptureReportRequest.NoLegsGroup, False)

        self.register_group(NoDates, TradeCaptureReportRequest.NoDatesGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, TradeCaptureReportRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, TradeCaptureReportRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, TradeCaptureReportRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, TradeCaptureReportRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class TradeCaptureReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, TradeCaptureReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, TradeCaptureReport.NoEventsGroup, False)
        ...
        self.register_field(YieldRedemptionPrice, False)
        self.register_field(YieldRedemptionPriceType, False)
        self.register_group(NoUnderlyings, TradeCaptureReport.NoUnderlyingsGroup, False)
        ...
        self.register_group(NoPosAmt, TradeCaptureReport.NoPosAmtGroup, False)

        self.register_field(MultiLegReportingType, False)
        self.register_field(TradeLegRefID, False)
        self.register_group(NoLegs, TradeCaptureReport.NoLegsGroup, False)

        self.register_field(TransactTime, True)
        self.register_group(NoTrdRegTimestamps, TradeCaptureReport.NoTrdRegTimestampsGroup, False)

        self.register_field(SettlType, False)
        self.register_field(SettlDate, False)
        self.register_field(MatchStatus, False)
        self.register_field(MatchType, False)
        self.register_group(NoSides, TradeCaptureReport.NoSidesGroup, True)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, TradeCaptureReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, TradeCaptureReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, TradeCaptureReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegQty, False)
            self.register_field(LegSwapType, False)
            self.register_group(NoLegStipulations, TradeCaptureReport.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_field(LegPositionEffect, False)
            self.register_field(LegCoveredOrUncovered, False)
            self.register_group(NoNestedPartyIDs, TradeCaptureReport.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, TradeCaptureReport.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoSidesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ListID, False)
            self.register_group(NoPartyIDs, TradeCaptureReport.NoSidesGroup.NoPartyIDsGroup, False)
            ...
            self.register_group(NoClearingInstructions, TradeCaptureReport.NoSidesGroup.NoClearingInstructionsGroup, False)
            ...
            self.register_group(NoContAmts, TradeCaptureReport.NoSidesGroup.NoContAmtsGroup, False)

            self.register_group(NoStipulations, TradeCaptureReport.NoSidesGroup.NoStipulationsGroup, False)

            self.register_group(NoMiscFees, TradeCaptureReport.NoSidesGroup.NoMiscFeesGroup, False)

            self.register_field(ExchangeRule, False)
            self.register_field(TradeAllocIndicator, False)
            self.register_field(PreallocMethod, False)
            self.register_field(AllocID, False)
            self.register_group(NoAllocs, TradeCaptureReport.NoSidesGroup.NoAllocsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, TradeCaptureReport.NoSidesGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
        ...
        class NoAllocsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(AllocSettlCurrency, False)
                self.register_field(IndividualAllocID, False)
                self.register_group(NoNested2PartyIDs, TradeCaptureReport.NoSidesGroup.NoAllocsGroup.NoNested2PartyIDsGroup, False)
            ...
            class NoNested2PartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(Nested2PartyIDSource, False)
                    self.register_field(Nested2PartyRole, False)
                    self.register_group(NoNested2PartySubIDs, TradeCaptureReport.NoSidesGroup.NoAllocsGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
...
class OrderMassStatusRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, OrderMassStatusRequest.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, OrderMassStatusRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, OrderMassStatusRequest.NoEventsGroup, False)
        ...
        self.register_field(UnderlyingSecurityID, False)
        self.register_field(UnderlyingSecurityIDSource, False)
        self.register_group(NoUnderlyingSecurityAltID, OrderMassStatusRequest.NoUnderlyingSecurityAltIDGroup, False)
        ...
        self.register_field(UnderlyingCurrentValue, False)
        self.register_field(UnderlyingEndValue, False)
        self.register_group(NoUnderlyingStips, OrderMassStatusRequest.NoUnderlyingStipsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, OrderMassStatusRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class QuoteRequestReject(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoRelatedSym, QuoteRequestReject.NoRelatedSymGroup, True)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, QuoteRequestReject.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, QuoteRequestReject.NoRelatedSymGroup.NoEventsGroup, False)
            ...
            self.register_field(DeliveryType, False)
            self.register_field(MarginRatio, False)
            self.register_group(NoUnderlyings, QuoteRequestReject.NoRelatedSymGroup.NoUnderlyingsGroup, False)
            ...
            self.register_field(OrderQty2, False)
            self.register_field(Currency, False)
            self.register_group(NoStipulations, QuoteRequestReject.NoRelatedSymGroup.NoStipulationsGroup, False)

            self.register_field(Account, False)
            self.register_field(AcctIDSource, False)
            self.register_field(AccountType, False)
            self.register_group(NoLegs, QuoteRequestReject.NoRelatedSymGroup.NoLegsGroup, False)

            self.register_group(NoQuoteQualifiers, QuoteRequestReject.NoRelatedSymGroup.NoQuoteQualifiersGroup, False)
            ...
            self.register_field(YieldRedemptionPrice, False)
            self.register_field(YieldRedemptionPriceType, False)
            self.register_group(NoPartyIDs, QuoteRequestReject.NoRelatedSymGroup.NoPartyIDsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, QuoteRequestReject.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, QuoteRequestReject.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, QuoteRequestReject.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
                ...
                self.register_field(LegSettlType, False)
                self.register_field(LegSettlDate, False)
                self.register_group(NoLegStipulations, QuoteRequestReject.NoRelatedSymGroup.NoLegsGroup.NoLegStipulationsGroup, False)

                self.register_group(NoNestedPartyIDs, QuoteRequestReject.NoRelatedSymGroup.NoLegsGroup.NoNestedPartyIDsGroup, False)
            ...
            class NoNestedPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(NestedPartyIDSource, False)
                    self.register_field(NestedPartyRole, False)
                    self.register_group(NoNestedPartySubIDs, QuoteRequestReject.NoRelatedSymGroup.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
        ...
        class NoPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(PartyIDSource, False)
                self.register_field(PartyRole, False)
                self.register_group(NoPartySubIDs, QuoteRequestReject.NoRelatedSymGroup.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class RFQRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoRelatedSym, RFQRequest.NoRelatedSymGroup, True)
    ...
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecurityID, False)
            self.register_field(SecurityIDSource, False)
            self.register_group(NoSecurityAltID, RFQRequest.NoRelatedSymGroup.NoSecurityAltIDGroup, False)
            ...
            self.register_field(CPProgram, False)
            self.register_field(CPRegType, False)
            self.register_group(NoEvents, RFQRequest.NoRelatedSymGroup.NoEventsGroup, False)

            self.register_field(DatedDate, False)
            self.register_field(InterestAccrualDate, False)
            self.register_group(NoUnderlyings, RFQRequest.NoRelatedSymGroup.NoUnderlyingsGroup, False)

            self.register_group(NoLegs, RFQRequest.NoRelatedSymGroup.NoLegsGroup, False)
        ...
        class NoUnderlyingsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(UnderlyingSecurityID, False)
                self.register_field(UnderlyingSecurityIDSource, False)
                self.register_group(NoUnderlyingSecurityAltID, RFQRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
                ...
                self.register_field(UnderlyingCurrentValue, False)
                self.register_field(UnderlyingEndValue, False)
                self.register_group(NoUnderlyingStips, RFQRequest.NoRelatedSymGroup.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
        ...
        class NoLegsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(LegSecurityID, False)
                self.register_field(LegSecurityIDSource, False)
                self.register_group(NoLegSecurityAltID, RFQRequest.NoRelatedSymGroup.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class QuoteStatusReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(QuoteRespID, False)
        self.register_field(QuoteType, False)
        self.register_group(NoPartyIDs, QuoteStatusReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, QuoteStatusReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, QuoteStatusReport.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, QuoteStatusReport.NoUnderlyingsGroup, False)
        ...
        self.register_field(OrderQty2, False)
        self.register_field(Currency, False)
        self.register_group(NoStipulations, QuoteStatusReport.NoStipulationsGroup, False)

        self.register_field(Account, False)
        self.register_field(AcctIDSource, False)
        self.register_field(AccountType, False)
        self.register_group(NoLegs, QuoteStatusReport.NoLegsGroup, False)

        self.register_group(NoQuoteQualifiers, QuoteStatusReport.NoQuoteQualifiersGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, QuoteStatusReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, QuoteStatusReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, QuoteStatusReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, QuoteStatusReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegSettlType, False)
            self.register_field(LegSettlDate, False)
            self.register_group(NoLegStipulations, QuoteStatusReport.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_group(NoNestedPartyIDs, QuoteStatusReport.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, QuoteStatusReport.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class QuoteResponse(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(IOIID, False)
        self.register_field(QuoteType, False)
        self.register_group(NoQuoteQualifiers, QuoteResponse.NoQuoteQualifiersGroup, False)

        self.register_group(NoPartyIDs, QuoteResponse.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, QuoteResponse.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, QuoteResponse.NoEventsGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, QuoteResponse.NoUnderlyingsGroup, False)
        ...
        self.register_field(OrderQty2, False)
        self.register_field(Currency, False)
        self.register_group(NoStipulations, QuoteResponse.NoStipulationsGroup, False)

        self.register_field(Account, False)
        self.register_field(AcctIDSource, False)
        self.register_field(AccountType, False)
        self.register_group(NoLegs, QuoteResponse.NoLegsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, QuoteResponse.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, QuoteResponse.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, QuoteResponse.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, QuoteResponse.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegSettlType, False)
            self.register_field(LegSettlDate, False)
            self.register_group(NoLegStipulations, QuoteResponse.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_group(NoNestedPartyIDs, QuoteResponse.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, QuoteResponse.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class Confirmation(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, Confirmation.NoPartyIDsGroup, False)

        self.register_group(NoOrders, Confirmation.NoOrdersGroup, False)
        ...
        self.register_field(TransactTime, True)
        self.register_field(TradeDate, True)
        self.register_group(NoTrdRegTimestamps, Confirmation.NoTrdRegTimestampsGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, Confirmation.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, Confirmation.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, Confirmation.NoInstrAttribGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, Confirmation.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, Confirmation.NoLegsGroup, False)
        ...
        self.register_field(Currency, False)
        self.register_field(LastMkt, False)
        self.register_group(NoCapacities, Confirmation.NoCapacitiesGroup, True)
        ...
        self.register_field(StandInstDbName, False)
        self.register_field(StandInstDbID, False)
        self.register_group(NoDlvyInst, Confirmation.NoDlvyInstGroup, False)
        ...
        self.register_group(NoStipulations, Confirmation.NoStipulationsGroup, False)

        self.register_group(NoMiscFees, Confirmation.NoMiscFeesGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, Confirmation.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ListID, False)
            self.register_group(NoNested2PartyIDs, Confirmation.NoOrdersGroup.NoNested2PartyIDsGroup, False)
        ...
        class NoNested2PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(Nested2PartyIDSource, False)
                self.register_field(Nested2PartyRole, False)
                self.register_group(NoNested2PartySubIDs, Confirmation.NoOrdersGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, Confirmation.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, Confirmation.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, Confirmation.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoDlvyInstGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SettlInstSource, False)
            self.register_field(DlvyInstType, False)
            self.register_group(NoSettlPartyIDs, Confirmation.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
        ...
        class NoSettlPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlPartyIDSource, False)
                self.register_field(SettlPartyRole, False)
                self.register_group(NoSettlPartySubIDs, Confirmation.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class PositionMaintenanceRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, PositionMaintenanceRequest.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, PositionMaintenanceRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, PositionMaintenanceRequest.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, PositionMaintenanceRequest.NoLegsGroup, False)

        self.register_group(NoUnderlyings, PositionMaintenanceRequest.NoUnderlyingsGroup, False)

        self.register_group(NoTradingSessions, PositionMaintenanceRequest.NoTradingSessionsGroup, False)

        self.register_field(TransactTime, True)
        self.register_group(NoPositions, PositionMaintenanceRequest.NoPositionsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, PositionMaintenanceRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, PositionMaintenanceRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, PositionMaintenanceRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, PositionMaintenanceRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoPositionsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_group(NoNestedPartyIDs, PositionMaintenanceRequest.NoPositionsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, PositionMaintenanceRequest.NoPositionsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class PositionMaintenanceReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SettlSessID, False)
        self.register_field(SettlSessSubID, False)
        self.register_group(NoPartyIDs, PositionMaintenanceReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, PositionMaintenanceReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, PositionMaintenanceReport.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, PositionMaintenanceReport.NoLegsGroup, False)

        self.register_group(NoUnderlyings, PositionMaintenanceReport.NoUnderlyingsGroup, False)

        self.register_group(NoTradingSessions, PositionMaintenanceReport.NoTradingSessionsGroup, False)

        self.register_field(TransactTime, True)
        self.register_group(NoPositions, PositionMaintenanceReport.NoPositionsGroup, False)

        self.register_group(NoPosAmt, PositionMaintenanceReport.NoPosAmtGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, PositionMaintenanceReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, PositionMaintenanceReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, PositionMaintenanceReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, PositionMaintenanceReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoPositionsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(ShortQty, False)
            self.register_field(PosQtyStatus, False)
            self.register_group(NoNestedPartyIDs, PositionMaintenanceReport.NoPositionsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, PositionMaintenanceReport.NoPositionsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class RequestForPositions(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(MatchStatus, False)
        self.register_field(SubscriptionRequestType, False)
        self.register_group(NoPartyIDs, RequestForPositions.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, RequestForPositions.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, RequestForPositions.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, RequestForPositions.NoLegsGroup, False)

        self.register_group(NoUnderlyings, RequestForPositions.NoUnderlyingsGroup, False)

        self.register_field(ClearingBusinessDate, True)
        self.register_field(SettlSessID, False)
        self.register_field(SettlSessSubID, False)
        self.register_group(NoTradingSessions, RequestForPositions.NoTradingSessionsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, RequestForPositions.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, RequestForPositions.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, RequestForPositions.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, RequestForPositions.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class RequestForPositionsAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoPartyIDs, RequestForPositionsAck.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, RequestForPositionsAck.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, RequestForPositionsAck.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, RequestForPositionsAck.NoLegsGroup, False)

        self.register_group(NoUnderlyings, RequestForPositionsAck.NoUnderlyingsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, RequestForPositionsAck.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, RequestForPositionsAck.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, RequestForPositionsAck.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, RequestForPositionsAck.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class PositionReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SettlSessID, False)
        self.register_field(SettlSessSubID, False)
        self.register_group(NoPartyIDs, PositionReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, PositionReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, PositionReport.NoEventsGroup, False)
        ...
        self.register_group(NoLegs, PositionReport.NoLegsGroup, False)

        self.register_group(NoUnderlyings, PositionReport.NoUnderlyingsGroup, False)

        self.register_group(NoPositions, PositionReport.NoPositionsGroup, False)

        self.register_group(NoPosAmt, PositionReport.NoPosAmtGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, PositionReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, PositionReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, PositionReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, PositionReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoPositionsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(ShortQty, False)
            self.register_field(PosQtyStatus, False)
            self.register_group(NoNestedPartyIDs, PositionReport.NoPositionsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, PositionReport.NoPositionsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class TradeCaptureReportRequestAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, TradeCaptureReportRequestAck.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, TradeCaptureReportRequestAck.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_group(NoUnderlyings, TradeCaptureReportRequestAck.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, TradeCaptureReportRequestAck.NoLegsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, TradeCaptureReportRequestAck.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, TradeCaptureReportRequestAck.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, TradeCaptureReportRequestAck.NoLegsGroup.NoLegSecurityAltIDGroup, False)
...
class TradeCaptureReportAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, TradeCaptureReportAck.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, TradeCaptureReportAck.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(TransactTime, False)
        self.register_group(NoTrdRegTimestamps, TradeCaptureReportAck.NoTrdRegTimestampsGroup, False)
        ...
        self.register_field(EncodedTextLen, False)
        self.register_field(EncodedText, False)
        self.register_group(NoLegs, TradeCaptureReportAck.NoLegsGroup, False)
        ...
        self.register_field(PositionEffect, False)
        self.register_field(PreallocMethod, False)
        self.register_group(NoAllocs, TradeCaptureReportAck.NoAllocsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, TradeCaptureReportAck.NoLegsGroup.NoLegSecurityAltIDGroup, False)
            ...
            self.register_field(LegQty, False)
            self.register_field(LegSwapType, False)
            self.register_group(NoLegStipulations, TradeCaptureReportAck.NoLegsGroup.NoLegStipulationsGroup, False)

            self.register_field(LegPositionEffect, False)
            self.register_field(LegCoveredOrUncovered, False)
            self.register_group(NoNestedPartyIDs, TradeCaptureReportAck.NoLegsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, TradeCaptureReportAck.NoLegsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(AllocSettlCurrency, False)
            self.register_field(IndividualAllocID, False)
            self.register_group(NoNested2PartyIDs, TradeCaptureReportAck.NoAllocsGroup.NoNested2PartyIDsGroup, False)
        ...
        class NoNested2PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(Nested2PartyIDSource, False)
                self.register_field(Nested2PartyRole, False)
                self.register_group(NoNested2PartySubIDs, TradeCaptureReportAck.NoAllocsGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
...
class AllocationReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(BookingRefID, False)
        self.register_field(AllocNoOrdersType, True)
        self.register_group(NoOrders, AllocationReport.NoOrdersGroup, False)

        self.register_group(NoExecs, AllocationReport.NoExecsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, AllocationReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, AllocationReport.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(DeliveryForm, False)
        self.register_field(PctAtRisk, False)
        self.register_group(NoInstrAttrib, AllocationReport.NoInstrAttribGroup, False)
        ...
        self.register_field(DeliveryType, False)
        self.register_field(MarginRatio, False)
        self.register_group(NoUnderlyings, AllocationReport.NoUnderlyingsGroup, False)

        self.register_group(NoLegs, AllocationReport.NoLegsGroup, False)
        ...
        self.register_field(Currency, False)
        self.register_field(AvgPxPrecision, False)
        self.register_group(NoPartyIDs, AllocationReport.NoPartyIDsGroup, False)
        ...
        self.register_field(EndCash, False)
        self.register_field(LegalConfirm, False)
        self.register_group(NoStipulations, AllocationReport.NoStipulationsGroup, False)
        ...
        self.register_field(TotNoAllocs, False)
        self.register_field(LastFragment, False)
        self.register_group(NoAllocs, AllocationReport.NoAllocsGroup, False)
    ...
    class NoOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ListID, False)
            self.register_group(NoNested2PartyIDs, AllocationReport.NoOrdersGroup.NoNested2PartyIDsGroup, False)
        ...
        class NoNested2PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(Nested2PartyIDSource, False)
                self.register_field(Nested2PartyRole, False)
                self.register_group(NoNested2PartySubIDs, AllocationReport.NoOrdersGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, AllocationReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, AllocationReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, AllocationReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, AllocationReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(IndividualAllocID, False)
            self.register_field(ProcessCode, False)
            self.register_group(NoNestedPartyIDs, AllocationReport.NoAllocsGroup.NoNestedPartyIDsGroup, False)
            ...
            self.register_field(AllocAccruedInterestAmt, False)
            self.register_field(AllocInterestAtMaturity, False)
            self.register_group(NoMiscFees, AllocationReport.NoAllocsGroup.NoMiscFeesGroup, False)

            self.register_group(NoClearingInstructions, AllocationReport.NoAllocsGroup.NoClearingInstructionsGroup, False)
            ...
            self.register_field(StandInstDbName, False)
            self.register_field(StandInstDbID, False)
            self.register_group(NoDlvyInst, AllocationReport.NoAllocsGroup.NoDlvyInstGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, AllocationReport.NoAllocsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
        ...
        class NoDlvyInstGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlInstSource, False)
                self.register_field(DlvyInstType, False)
                self.register_group(NoSettlPartyIDs, AllocationReport.NoAllocsGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
            ...
            class NoSettlPartyIDsGroup(fix_message.FIXGroup):
                def __init__(self):
                    ...
                    self.register_field(SettlPartyIDSource, False)
                    self.register_field(SettlPartyRole, False)
                    self.register_group(NoSettlPartySubIDs, AllocationReport.NoAllocsGroup.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class AllocationReportAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(AllocReportID, True)
        self.register_field(AllocID, True)
        self.register_group(NoPartyIDs, AllocationReportAck.NoPartyIDsGroup, False)
        ...
        self.register_field(EncodedTextLen, False)
        self.register_field(EncodedText, False)
        self.register_group(NoAllocs, AllocationReportAck.NoAllocsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, AllocationReportAck.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class SettlementInstructionRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(TransactTime, True)
        self.register_group(NoPartyIDs, SettlementInstructionRequest.NoPartyIDsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, SettlementInstructionRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
...
class AssignmentReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(LastRptRequested, False)
        self.register_group(NoPartyIDs, AssignmentReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, AssignmentReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, AssignmentReport.NoEventsGroup, False)

        self.register_field(DatedDate, False)
        self.register_field(InterestAccrualDate, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, AssignmentReport.NoLegsGroup, False)

        self.register_group(NoUnderlyings, AssignmentReport.NoUnderlyingsGroup, False)

        self.register_group(NoPositions, AssignmentReport.NoPositionsGroup, False)

        self.register_group(NoPosAmt, AssignmentReport.NoPosAmtGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, AssignmentReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, AssignmentReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, AssignmentReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, AssignmentReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoPositionsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(ShortQty, False)
            self.register_field(PosQtyStatus, False)
            self.register_group(NoNestedPartyIDs, AssignmentReport.NoPositionsGroup.NoNestedPartyIDsGroup, False)
        ...
        class NoNestedPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(NestedPartyIDSource, False)
                self.register_field(NestedPartyRole, False)
                self.register_group(NoNestedPartySubIDs, AssignmentReport.NoPositionsGroup.NoNestedPartyIDsGroup.NoNestedPartySubIDsGroup, False)
...
class CollateralRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(TransactTime, True)
        self.register_field(ExpireTime, False)
        self.register_group(NoPartyIDs, CollateralRequest.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralRequest.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralRequest.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralRequest.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralRequest.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralRequest.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralRequest.NoUnderlyingsGroup, False)

        self.register_field(MarginExcess, False)
        self.register_field(TotalNetValue, False)
        self.register_field(CashOutstanding, False)
        self.register_group(NoTrdRegTimestamps, CollateralRequest.NoTrdRegTimestampsGroup, False)

        self.register_field(Side, False)
        self.register_group(NoMiscFees, CollateralRequest.NoMiscFeesGroup, False)
        ...
        self.register_field(BenchmarkSecurityID, False)
        self.register_field(BenchmarkSecurityIDSource, False)
        self.register_group(NoStipulations, CollateralRequest.NoStipulationsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralRequest.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralRequest.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralRequest.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralRequest.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class CollateralAssignment(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(TransactTime, True)
        self.register_field(ExpireTime, False)
        self.register_group(NoPartyIDs, CollateralAssignment.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralAssignment.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralAssignment.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralAssignment.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralAssignment.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralAssignment.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralAssignment.NoUnderlyingsGroup, False)

        self.register_field(MarginExcess, False)
        self.register_field(TotalNetValue, False)
        self.register_field(CashOutstanding, False)
        self.register_group(NoTrdRegTimestamps, CollateralAssignment.NoTrdRegTimestampsGroup, False)

        self.register_field(Side, False)
        self.register_group(NoMiscFees, CollateralAssignment.NoMiscFeesGroup, False)
        ...
        self.register_field(BenchmarkSecurityID, False)
        self.register_field(BenchmarkSecurityIDSource, False)
        self.register_group(NoStipulations, CollateralAssignment.NoStipulationsGroup, False)

        self.register_field(SettlDeliveryType, False)
        self.register_field(StandInstDbType, False)
        self.register_field(StandInstDbName, False)
        self.register_field(StandInstDbID, False)
        self.register_group(NoDlvyInst, CollateralAssignment.NoDlvyInstGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralAssignment.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralAssignment.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralAssignment.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralAssignment.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoDlvyInstGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SettlInstSource, False)
            self.register_field(DlvyInstType, False)
            self.register_group(NoSettlPartyIDs, CollateralAssignment.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
        ...
        class NoSettlPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlPartyIDSource, False)
                self.register_field(SettlPartyRole, False)
                self.register_group(NoSettlPartySubIDs, CollateralAssignment.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class CollateralResponse(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(TransactTime, True)
        self.register_group(NoPartyIDs, CollateralResponse.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralResponse.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralResponse.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralResponse.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralResponse.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralResponse.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralResponse.NoUnderlyingsGroup, False)

        self.register_field(MarginExcess, False)
        self.register_field(TotalNetValue, False)
        self.register_field(CashOutstanding, False)
        self.register_group(NoTrdRegTimestamps, CollateralResponse.NoTrdRegTimestampsGroup, False)

        self.register_field(Side, False)
        self.register_group(NoMiscFees, CollateralResponse.NoMiscFeesGroup, False)
        ...
        self.register_field(BenchmarkSecurityID, False)
        self.register_field(BenchmarkSecurityIDSource, False)
        self.register_group(NoStipulations, CollateralResponse.NoStipulationsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralResponse.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralResponse.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralResponse.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralResponse.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class CollateralReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(TotNumReports, False)
        self.register_field(LastRptRequested, False)
        self.register_group(NoPartyIDs, CollateralReport.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralReport.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralReport.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralReport.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralReport.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralReport.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralReport.NoUnderlyingsGroup, False)

        self.register_field(MarginExcess, False)
        self.register_field(TotalNetValue, False)
        self.register_field(CashOutstanding, False)
        self.register_group(NoTrdRegTimestamps, CollateralReport.NoTrdRegTimestampsGroup, False)

        self.register_field(Side, False)
        self.register_group(NoMiscFees, CollateralReport.NoMiscFeesGroup, False)
        ...
        self.register_field(BenchmarkSecurityID, False)
        self.register_field(BenchmarkSecurityIDSource, False)
        self.register_group(NoStipulations, CollateralReport.NoStipulationsGroup, False)

        self.register_field(SettlDeliveryType, False)
        self.register_field(StandInstDbType, False)
        self.register_field(StandInstDbName, False)
        self.register_field(StandInstDbID, False)
        self.register_group(NoDlvyInst, CollateralReport.NoDlvyInstGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralReport.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralReport.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralReport.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralReport.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoDlvyInstGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SettlInstSource, False)
            self.register_field(DlvyInstType, False)
            self.register_group(NoSettlPartyIDs, CollateralReport.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
        ...
        class NoSettlPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlPartyIDSource, False)
                self.register_field(SettlPartyRole, False)
                self.register_group(NoSettlPartySubIDs, CollateralReport.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class CollateralInquiry(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(CollInquiryID, False)
        self.register_group(NoCollInquiryQualifier, CollateralInquiry.NoCollInquiryQualifierGroup, False)

        self.register_field(SubscriptionRequestType, False)
        self.register_field(ResponseTransportType, False)
        self.register_field(ResponseDestination, False)
        self.register_group(NoPartyIDs, CollateralInquiry.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralInquiry.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralInquiry.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralInquiry.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralInquiry.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralInquiry.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralInquiry.NoUnderlyingsGroup, False)

        self.register_field(MarginExcess, False)
        self.register_field(TotalNetValue, False)
        self.register_field(CashOutstanding, False)
        self.register_group(NoTrdRegTimestamps, CollateralInquiry.NoTrdRegTimestampsGroup, False)
        ...
        self.register_field(BenchmarkSecurityID, False)
        self.register_field(BenchmarkSecurityIDSource, False)
        self.register_group(NoStipulations, CollateralInquiry.NoStipulationsGroup, False)

        self.register_field(SettlDeliveryType, False)
        self.register_field(StandInstDbType, False)
        self.register_field(StandInstDbName, False)
        self.register_field(StandInstDbID, False)
        self.register_group(NoDlvyInst, CollateralInquiry.NoDlvyInstGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralInquiry.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralInquiry.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralInquiry.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralInquiry.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
    ...
    class NoDlvyInstGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SettlInstSource, False)
            self.register_field(DlvyInstType, False)
            self.register_group(NoSettlPartyIDs, CollateralInquiry.NoDlvyInstGroup.NoSettlPartyIDsGroup, False)
        ...
        class NoSettlPartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(SettlPartyIDSource, False)
                self.register_field(SettlPartyRole, False)
                self.register_group(NoSettlPartySubIDs, CollateralInquiry.NoDlvyInstGroup.NoSettlPartyIDsGroup.NoSettlPartySubIDsGroup, False)
...
class NetworkCounterpartySystemStatusRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoCompIDs, NetworkCounterpartySystemStatusRequest.NoCompIDsGroup, False)
...
class NetworkCounterpartySystemStatusResponse(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoCompIDs, NetworkCounterpartySystemStatusResponse.NoCompIDsGroup, True)
...
class CollateralInquiryAck(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_group(NoCollInquiryQualifier, CollateralInquiryAck.NoCollInquiryQualifierGroup, False)

        self.register_field(TotNumReports, False)
        self.register_group(NoPartyIDs, CollateralInquiryAck.NoPartyIDsGroup, False)
        ...
        self.register_field(SecondaryOrderID, False)
        self.register_field(SecondaryClOrdID, False)
        self.register_group(NoExecs, CollateralInquiryAck.NoExecsGroup, False)

        self.register_group(NoTrades, CollateralInquiryAck.NoTradesGroup, False)

        self.register_field(Symbol, False)
        self.register_field(SymbolSfx, False)
        self.register_field(SecurityID, False)
        self.register_field(SecurityIDSource, False)
        self.register_group(NoSecurityAltID, CollateralInquiryAck.NoSecurityAltIDGroup, False)
        ...
        self.register_field(CPProgram, False)
        self.register_field(CPRegType, False)
        self.register_group(NoEvents, CollateralInquiryAck.NoEventsGroup, False)
        ...
        self.register_field(QtyType, False)
        self.register_field(Currency, False)
        self.register_group(NoLegs, CollateralInquiryAck.NoLegsGroup, False)

        self.register_group(NoUnderlyings, CollateralInquiryAck.NoUnderlyingsGroup, False)
    ...
    class NoPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(PartyIDSource, False)
            self.register_field(PartyRole, False)
            self.register_group(NoPartySubIDs, CollateralInquiryAck.NoPartyIDsGroup.NoPartySubIDsGroup, False)
    ...
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(LegSecurityID, False)
            self.register_field(LegSecurityIDSource, False)
            self.register_group(NoLegSecurityAltID, CollateralInquiryAck.NoLegsGroup.NoLegSecurityAltIDGroup, False)
    ...
    class NoUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(UnderlyingSecurityID, False)
            self.register_field(UnderlyingSecurityIDSource, False)
            self.register_group(NoUnderlyingSecurityAltID, CollateralInquiryAck.NoUnderlyingsGroup.NoUnderlyingSecurityAltIDGroup, False)
            ...
            self.register_field(UnderlyingCurrentValue, False)
            self.register_field(UnderlyingEndValue, False)
            self.register_group(NoUnderlyingStips, CollateralInquiryAck.NoUnderlyingsGroup.NoUnderlyingStipsGroup, False)
...
class ConfirmationRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(ConfirmType, True)
        self.register_group(NoOrders, ConfirmationRequest.NoOrdersGroup, False)
    ...
    class NoOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(SecondaryClOrdID, False)
            self.register_field(ListID, False)
            self.register_group(NoNested2PartyIDs, ConfirmationRequest.NoOrdersGroup.NoNested2PartyIDsGroup, False)
        ...
        class NoNested2PartyIDsGroup(fix_message.FIXGroup):
            def __init__(self):
                ...
                self.register_field(Nested2PartyIDSource, False)
                self.register_field(Nested2PartyRole, False)
                self.register_group(NoNested2PartySubIDs, ConfirmationRequest.NoOrdersGroup.NoNested2PartyIDsGroup.NoNested2PartySubIDsGroup, False)
