...
def register_Instrument_component(self):
    ...
    self.register_field(fields.OptPayAmount, False)
    self.register_field(fields.PriceQuoteMethod, False)
    self.register_field(fields.FuturesValuationMethod, False)
...
def register_DerivativeInstrument_component(self):
    ...
    self.register_field(fields.DerivativeFuturesValuationMethod, False)
