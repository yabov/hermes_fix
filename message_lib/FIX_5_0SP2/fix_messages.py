...
def register_Instrument_component(self):
    ...
    self.register_field(fields.ProductComplex, False)
    self.register_field(fields.SecurityGroup, False)
    ...
    self.register_field(fields.RestructuringType, False)
    self.register_field(fields.Seniority, False)
    self.register_field(fields.NotionalPercentageOutstanding, False)
    self.register_field(fields.OriginalNotionalPercentageOutstanding, False)
    self.register_field(fields.AttachmentPoint, False)
    self.register_field(fields.DetachmentPoint, False)
    ...
    self.register_field(fields.StrikePriceDeterminationMethod, False)
    self.register_field(fields.StrikePriceBoundaryMethod, False)
    self.register_field(fields.StrikePriceBoundaryPrecision, False)
    self.register_field(fields.UnderlyingPriceDeterminationMethod, False)
    self.register_field(fields.OptAttribute, False)
    self.register_field(fields.ContractMultiplier, False)
    self.register_field(fields.ContractMultiplierUnit, False)
    self.register_field(fields.FlowScheduleType, False)
    self.register_field(fields.MinPriceIncrement, False)
    self.register_field(fields.MinPriceIncrementAmount, False)
    self.register_field(fields.UnitOfMeasure, False)
    self.register_field(fields.UnitOfMeasureQty, False)
    self.register_field(fields.PriceUnitOfMeasure, False)
    self.register_field(fields.PriceUnitOfMeasureQty, False)
    self.register_field(fields.SettlMethod, False)
    self.register_field(fields.ExerciseStyle, False)
    self.register_field(fields.OptPayoutType, False)
    self.register_field(fields.OptPayoutAmount, False)
    self.register_field(fields.PriceQuoteMethod, False)
    self.register_field(fields.ValuationMethod, False)
    self.register_field(fields.ListMethod, False)
    self.register_field(fields.CapPrice, False)
    self.register_field(fields.FloorPrice, False)
    self.register_field(fields.PutOrCall, False)
    self.register_field(fields.FlexibleIndicator, False)
    self.register_field(fields.FlexProductEligibilityIndicator, False)
    ...
    register_SecurityXML_component(self)
    ...
    register_ComplexEvents_component(self)
...
def register_InstrumentLeg_component(self):
    ...
    self.register_field(fields.LegMaturityTime, False)
    ...
    self.register_field(fields.LegContractMultiplierUnit, False)
    self.register_field(fields.LegFlowScheduleType, False)
    self.register_field(fields.LegUnitOfMeasure, False)
    self.register_field(fields.LegUnitOfMeasureQty, False)
    self.register_field(fields.LegPriceUnitOfMeasure, False)
    self.register_field(fields.LegPriceUnitOfMeasureQty, False)
    self.register_field(fields.LegTimeUnit, False)
    self.register_field(fields.LegExerciseStyle, False)
    ...
    self.register_field(fields.LegPutOrCall, False)
...
def register_UnderlyingInstrument_component(self):
    ...
    self.register_field(fields.UnderlyingMaturityTime, False)
    self.register_field(fields.UnderlyingCouponPaymentDate, False)
    self.register_field(fields.UnderlyingRestructuringType, False)
    self.register_field(fields.UnderlyingSeniority, False)
    self.register_field(fields.UnderlyingNotionalPercentageOutstanding, False)
    self.register_field(fields.UnderlyingOriginalNotionalPercentageOutstanding, False)
    self.register_field(fields.UnderlyingAttachmentPoint, False)
    self.register_field(fields.UnderlyingDetachmentPoint, False)
    ...
    self.register_field(fields.UnderlyingContractMultiplierUnit, False)
    self.register_field(fields.UnderlyingFlowScheduleType, False)
    self.register_field(fields.UnderlyingUnitOfMeasure, False)
    self.register_field(fields.UnderlyingUnitOfMeasureQty, False)
    self.register_field(fields.UnderlyingPriceUnitOfMeasure, False)
    self.register_field(fields.UnderlyingPriceUnitOfMeasureQty, False)
    self.register_field(fields.UnderlyingTimeUnit, False)
    self.register_field(fields.UnderlyingExerciseStyle, False)
...
def register_StandardHeader_component(self):
    ...
    self.register_field(fields.ApplExtID, False)
...
def register_InstrmtLegExecGrp_component(self):
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.LegAllocID, False)
            ...
            self.register_field(fields.LegVolatility, False)
            self.register_field(fields.LegDividendYield, False)
            self.register_field(fields.LegCurrencyRatio, False)
            self.register_field(fields.LegExecInst, False)
            self.register_field(fields.LegLastQty, False)
...
def register_InstrmtMDReqGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.MDStreamID, False)
...
def register_LegPreAllocGrp_component(self):
    class NoLegAllocsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.LegAllocSettlCurrency, False)
...
def register_MDFullGrp_component(self):
    class NoMDEntriesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.Currency, False)
            self.register_field(fields.SettlCurrency, False)
            register_RateSource_component(self)
            self.register_field(fields.MDEntrySize, False)
            register_SecSizesGrp_component(self)
...
def register_MDIncGrp_component(self):
    class NoMDEntriesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.MDSubBookType, False)
            self.register_field(fields.MarketDepth, False)
            ...
            self.register_field(fields.MDEntrySpotRate, False)
            self.register_field(fields.MDEntryForwardPoints, False)
            register_StatsIndGrp_component(self)
            register_Parties_component(self)
...
def register_QuotEntryAckGrp_component(self):
    class NoQuoteEntriesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.OrderCapacity, False)
            self.register_field(fields.OrderRestrictions, False)
            self.register_field(fields.QuoteEntryStatus, False)
...
def register_QuotSetAckGrp_component(self):
    class NoQuoteSetsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.TotNoCxldQuotes, False)
            self.register_field(fields.TotNoAccQuotes, False)
            self.register_field(fields.TotNoRejQuotes, False)
...
def register_RelSymDerivSecGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_Instrument_component(self)
            register_SecondaryPriceLimits_component(self)
            self.register_field(fields.Currency, False)
            self.register_field(fields.CorporateAction, False)
            register_InstrumentExtension_component(self)
            register_InstrmtLegGrp_component(self)
            self.register_field(fields.RelSymTransactTime, False)
            self.register_field(fields.Text, False)
            self.register_field(fields.EncodedTextLen, False)
            self.register_field(fields.EncodedText, False)
...
def register_SecListGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            register_InstrumentExtension_component(self)
            register_FinancingDetails_component(self)
            register_SecurityTradingRules_component(self)
            register_StrikeRules_component(self)
            register_UndInstrmtGrp_component(self)
            self.register_field(fields.Currency, False)
            register_Stipulations_component(self)
...
def register_TrdCapRptSideGrp_component(self):
    class NoSidesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.Side, True)
            self.register_field(fields.SideExecID, False)
            self.register_field(fields.OrderDelay, False)
            self.register_field(fields.OrderDelayUnit, False)
            self.register_field(fields.SideLastQty, False)
            ...
            self.register_field(fields.NetGrossInd, False)
            self.register_field(fields.SideCurrency, False)
            self.register_field(fields.SideSettlCurrency, False)
            register_Parties_component(self)
            self.register_field(fields.Account, False)
            self.register_field(fields.AcctIDSource, False)
            self.register_field(fields.AccountType, False)
            ...
            register_SettlDetails_component(self)
            ...
            self.register_field(fields.SideLiquidityInd, False)
            register_TradeReportOrderDetail_component(self)
...
def register_TrdInstrmtLegGrp_component(self):
    class NoLegsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.LegNumber, False)
            register_LegStipulations_component(self)
            self.register_field(fields.LegPositionEffect, False)
            self.register_field(fields.LegCoveredOrUncovered, False)
            register_NestedParties_component(self)
            ...
            self.register_field(fields.LegExecInst, False)
            self.register_field(fields.LegLastQty, False)
            register_TradeCapLegUnderlyingsGrp_component(self)
...
def register_EvntGrp_component(self):
    class NoEventsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.EventTime, False)
...
def register_SecLstUpdRelSymGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ListUpdateAction, False)
            register_Instrument_component(self)
            register_InstrumentExtension_component(self)
            register_FinancingDetails_component(self)
            register_SecurityTradingRules_component(self)
...
def register_ExpirationQty_component(self):
    class NoExpirationGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ExpirationQtyType, False)
...
def register_UndlyInstrumentParties_component(self):
    class NoUndlyInstrumentPartiesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.UnderlyingInstrumentPartyID, False)
            self.register_field(fields.UnderlyingInstrumentPartyIDSource, False)
            self.register_field(fields.UnderlyingInstrumentPartyRole, False)
...
def register_UndlyInstrumentPtysSubGrp_component(self):
    class NoUndlyInstrumentPartySubIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.UnderlyingInstrumentPartySubID, False)
            self.register_field(fields.UnderlyingInstrumentPartySubIDType, False)
...
def register_TrdSessLstGrp_component(self):
    class NoTradingSessionsGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.TradingSessionSubID, False)
            self.register_field(fields.TradSesUpdateAction, False)
            self.register_field(fields.SecurityExchange, False)
            self.register_field(fields.MarketID, False)
            self.register_field(fields.MarketSegmentID, False)
            self.register_field(fields.TradingSessionDesc, False)
            ...
            register_TradingSessionRules_component(self)
            self.register_field(fields.TransactTime, False)
            self.register_field(fields.Text, False)
            self.register_field(fields.EncodedTextLen, False)
            self.register_field(fields.EncodedText, False)
...
def register_MsgTypeGrp_component(self):
    class NoMsgTypesGroup(fix_message.FIXGroup):
        def __init__(self):
            ...
            self.register_field(fields.RefApplExtID, False)
            self.register_field(fields.RefCstmApplVerID, False)
            self.register_field(fields.DefaultVerIndicator, False)

    self.register_group(fields.NoMsgTypes, NoMsgTypesGroup, False)

def register_SecurityTradingRules_component(self):
    register_BaseTradingRules_component(self)
    register_TradingSessionRulesGrp_component(self)
    register_NestedInstrumentAttribute_component(self)

def register_SettlDetails_component(self):
    class NoSettlDetailsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.SettlObligSource, False)
            register_SettlParties_component(self)

    self.register_group(fields.NoSettlDetails, NoSettlDetailsGroup, False)

def register_SettlObligationInstructions_component(self):
    class NoSettlObligGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.NetGrossInd, False)
            self.register_field(fields.SettlObligID, False)
            self.register_field(fields.SettlObligTransType, False)
            self.register_field(fields.SettlObligRefID, False)
            self.register_field(fields.CcyAmt, False)
            self.register_field(fields.SettlCurrAmt, False)
            self.register_field(fields.Currency, False)
            self.register_field(fields.SettlCurrency, False)
            self.register_field(fields.SettlCurrFxRate, False)
    ...
    self.register_group(fields.NoSettlOblig, NoSettlObligGroup, False)

def register_SecSizesGrp_component(self):
    class NoOfSecSizesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.MDSecSizeType, False)
            self.register_field(fields.MDSecSize, False)

    self.register_group(fields.NoOfSecSizes, NoOfSecSizesGroup, False)

def register_StatsIndGrp_component(self):
    class NoStatsIndicatorsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.StatsType, False)

    self.register_group(fields.NoStatsIndicators, NoStatsIndicatorsGroup, False)

def register_SecurityXML_component(self):
    self.register_field(fields.SecurityXMLLen, False)
    self.register_field(fields.SecurityXML, False)
    self.register_field(fields.SecurityXMLSchema, False)

def register_TickRules_component(self):
    class NoTickRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.StartTickPriceRange, False)
            self.register_field(fields.EndTickPriceRange, False)
            self.register_field(fields.TickIncrement, False)
            self.register_field(fields.TickRuleType, False)

    self.register_group(fields.NoTickRules, NoTickRulesGroup, False)

def register_StrikeRules_component(self):
    class NoStrikeRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.StrikeRuleID, False)
            self.register_field(fields.StartStrikePxRange, False)
            self.register_field(fields.EndStrikePxRange, False)
            self.register_field(fields.StrikeIncrement, False)
            self.register_field(fields.StrikeExerciseStyle, False)
            register_MaturityRules_component(self)

    self.register_group(fields.NoStrikeRules, NoStrikeRulesGroup, False)

def register_MaturityRules_component(self):
    class NoMaturityRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.MaturityRuleID, False)
            self.register_field(fields.MaturityMonthYearFormat, False)
            self.register_field(fields.MaturityMonthYearIncrementUnits, False)
            self.register_field(fields.StartMaturityMonthYear, False)
            self.register_field(fields.EndMaturityMonthYear, False)
            self.register_field(fields.MaturityMonthYearIncrement, False)

    self.register_group(fields.NoMaturityRules, NoMaturityRulesGroup, False)

def register_SecondaryPriceLimits_component(self):
    self.register_field(fields.SecondaryPriceLimitType, False)
    self.register_field(fields.SecondaryLowLimitPrice, False)
    self.register_field(fields.SecondaryHighLimitPrice, False)
    self.register_field(fields.SecondaryTradingReferencePrice, False)

def register_PriceLimits_component(self):
    self.register_field(fields.PriceLimitType, False)
    self.register_field(fields.LowLimitPrice, False)
    self.register_field(fields.HighLimitPrice, False)
    self.register_field(fields.TradingReferencePrice, False)

def register_MarketDataFeedTypes_component(self):
    class NoMDFeedTypesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
    ...
    self.register_group(fields.NoMDFeedTypes, NoMDFeedTypesGroup, False)

def register_LotTypeRules_component(self):
    class NoLotTypeRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.LotType, False)
            self.register_field(fields.MinLotSize, False)

    self.register_group(fields.NoLotTypeRules, NoLotTypeRulesGroup, False)

def register_MatchRules_component(self):
    class NoMatchRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.MatchAlgorithm, False)
            self.register_field(fields.MatchType, False)

    self.register_group(fields.NoMatchRules, NoMatchRulesGroup, False)

def register_ExecInstRules_component(self):
    class NoExecInstRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ExecInstValue, False)

    self.register_group(fields.NoExecInstRules, NoExecInstRulesGroup, False)

def register_TimeInForceRules_component(self):
    class NoTimeInForceRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.TimeInForce, False)

    self.register_group(fields.NoTimeInForceRules, NoTimeInForceRulesGroup, False)

def register_OrdTypeRules_component(self):
    class NoOrdTypeRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.OrdType, False)

    self.register_group(fields.NoOrdTypeRules, NoOrdTypeRulesGroup, False)

def register_TradingSessionRules_component(self):
    register_OrdTypeRules_component(self)
    register_TimeInForceRules_component(self)
    register_ExecInstRules_component(self)
    register_MatchRules_component(self)
    register_MarketDataFeedTypes_component(self)

def register_TradingSessionRulesGrp_component(self):
    class NoTradingSessionRulesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.TradingSessionID, False)
            self.register_field(fields.TradingSessionSubID, False)
    ...
    self.register_group(fields.NoTradingSessionRules, NoTradingSessionRulesGroup, False)

def register_BaseTradingRules_component(self):
    register_TickRules_component(self)
    register_LotTypeRules_component(self)
    register_PriceLimits_component(self)
    self.register_field(fields.ExpirationCycle, False)
    self.register_field(fields.MinTradeVol, False)
    self.register_field(fields.MaxTradeVol, False)
    self.register_field(fields.MaxPriceVariation, False)
    self.register_field(fields.ImpliedMarketIndicator, False)
    self.register_field(fields.TradingCurrency, False)
    self.register_field(fields.RoundLot, False)
    self.register_field(fields.MultilegModel, False)
    self.register_field(fields.MultilegPriceMethod, False)
    self.register_field(fields.PriceType, False)

def register_MarketSegmentGrp_component(self):
    class NoMarketSegmentsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.MarketID, False)
            self.register_field(fields.MarketSegmentID, False)
    ...
    self.register_group(fields.NoMarketSegments, NoMarketSegmentsGroup, False)

def register_DerivativeInstrumentPartySubIDsGrp_component(self):
    class NoDerivativeInstrumentPartySubIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.DerivativeInstrumentPartySubID, False)
            self.register_field(fields.DerivativeInstrumentPartySubIDType, False)

    self.register_group(fields.NoDerivativeInstrumentPartySubIDs, NoDerivativeInstrumentPartySubIDsGroup, False)

def register_DerivativeInstrumentParties_component(self):
    class NoDerivativeInstrumentPartiesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.DerivativeInstrumentPartyID, False)
            self.register_field(fields.DerivativeInstrumentPartyIDSource, False)
            self.register_field(fields.DerivativeInstrumentPartyRole, False)
            register_DerivativeInstrumentPartySubIDsGrp_component(self)

    self.register_group(fields.NoDerivativeInstrumentParties, NoDerivativeInstrumentPartiesGroup, False)

def register_DerivativeInstrumentAttribute_component(self):
    class NoDerivativeInstrAttribGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.DerivativeInstrAttribType, False)
            self.register_field(fields.DerivativeInstrAttribValue, False)

    self.register_group(fields.NoDerivativeInstrAttrib, NoDerivativeInstrAttribGroup, False)

def register_NestedInstrumentAttribute_component(self):
    class NoNestedInstrAttribGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.NestedInstrAttribType, False)
            self.register_field(fields.NestedInstrAttribValue, False)

    self.register_group(fields.NoNestedInstrAttrib, NoNestedInstrAttribGroup, False)

def register_DerivativeInstrument_component(self):
    self.register_field(fields.DerivativeSymbol, False)
    self.register_field(fields.DerivativeSymbolSfx, False)
    self.register_field(fields.DerivativeSecurityID, False)
    self.register_field(fields.DerivativeSecurityIDSource, False)
    register_DerivativeSecurityAltIDGrp_component(self)
    self.register_field(fields.DerivativeProduct, False)
    self.register_field(fields.DerivativeProductComplex, False)
    self.register_field(fields.DerivFlexProductEligibilityIndicator, False)
    self.register_field(fields.DerivativeSecurityGroup, False)
    self.register_field(fields.DerivativeCFICode, False)
    self.register_field(fields.DerivativeSecurityType, False)
    self.register_field(fields.DerivativeSecuritySubType, False)
    self.register_field(fields.DerivativeMaturityMonthYear, False)
    self.register_field(fields.DerivativeMaturityDate, False)
    self.register_field(fields.DerivativeMaturityTime, False)
    self.register_field(fields.DerivativeSettleOnOpenFlag, False)
    self.register_field(fields.DerivativeInstrmtAssignmentMethod, False)
    self.register_field(fields.DerivativeSecurityStatus, False)
    self.register_field(fields.DerivativeIssueDate, False)
    self.register_field(fields.DerivativeInstrRegistry, False)
    self.register_field(fields.DerivativeCountryOfIssue, False)
    self.register_field(fields.DerivativeStateOrProvinceOfIssue, False)
    self.register_field(fields.DerivativeLocaleOfIssue, False)
    self.register_field(fields.DerivativeStrikePrice, False)
    self.register_field(fields.DerivativeStrikeCurrency, False)
    self.register_field(fields.DerivativeStrikeMultiplier, False)
    self.register_field(fields.DerivativeStrikeValue, False)
    self.register_field(fields.DerivativeOptAttribute, False)
    self.register_field(fields.DerivativeContractMultiplier, False)
    self.register_field(fields.DerivativeContractMultiplierUnit, False)
    self.register_field(fields.DerivativeFlowScheduleType, False)
    self.register_field(fields.DerivativeMinPriceIncrement, False)
    self.register_field(fields.DerivativeMinPriceIncrementAmount, False)
    self.register_field(fields.DerivativeUnitOfMeasure, False)
    self.register_field(fields.DerivativeUnitOfMeasureQty, False)
    self.register_field(fields.DerivativePriceUnitOfMeasure, False)
    self.register_field(fields.DerivativePriceUnitOfMeasureQty, False)
    self.register_field(fields.DerivativeSettlMethod, False)
    self.register_field(fields.DerivativePriceQuoteMethod, False)
    self.register_field(fields.DerivativeValuationMethod, False)
    self.register_field(fields.DerivativeListMethod, False)
    self.register_field(fields.DerivativeCapPrice, False)
    self.register_field(fields.DerivativeFloorPrice, False)
    self.register_field(fields.DerivativePutOrCall, False)
    self.register_field(fields.DerivativeExerciseStyle, False)
    self.register_field(fields.DerivativeOptPayAmount, False)
    self.register_field(fields.DerivativeTimeUnit, False)
    self.register_field(fields.DerivativeSecurityExchange, False)
    self.register_field(fields.DerivativePositionLimit, False)
    self.register_field(fields.DerivativeNTPositionLimit, False)
    self.register_field(fields.DerivativeIssuer, False)
    self.register_field(fields.DerivativeEncodedIssuerLen, False)
    self.register_field(fields.DerivativeEncodedIssuer, False)
    self.register_field(fields.DerivativeSecurityDesc, False)
    self.register_field(fields.DerivativeEncodedSecurityDescLen, False)
    self.register_field(fields.DerivativeEncodedSecurityDesc, False)
    register_DerivativeSecurityXML_component(self)
    self.register_field(fields.DerivativeContractSettlMonth, False)
    register_DerivativeEventsGrp_component(self)
    register_DerivativeInstrumentParties_component(self)

def register_DerivativeSecurityAltIDGrp_component(self):
    class NoDerivativeSecurityAltIDGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.DerivativeSecurityAltID, False)
            self.register_field(fields.DerivativeSecurityAltIDSource, False)

    self.register_group(fields.NoDerivativeSecurityAltID, NoDerivativeSecurityAltIDGroup, False)

def register_DerivativeEventsGrp_component(self):
    class NoDerivativeEventsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.DerivativeEventType, False)
            self.register_field(fields.DerivativeEventDate, False)
            self.register_field(fields.DerivativeEventTime, False)
            self.register_field(fields.DerivativeEventPx, False)
            self.register_field(fields.DerivativeEventText, False)

    self.register_group(fields.NoDerivativeEvents, NoDerivativeEventsGroup, False)

def register_DerivativeSecurityDefinition_component(self):
    register_DerivativeInstrument_component(self)
    register_DerivativeInstrumentAttribute_component(self)
    register_MarketSegmentGrp_component(self)

def register_RelSymDerivSecUpdGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ListUpdateAction, False)
...
def register_DerivativeSecurityXML_component(self):
    self.register_field(fields.DerivativeSecurityXMLLen, False)
    self.register_field(fields.DerivativeSecurityXML, False)
    self.register_field(fields.DerivativeSecurityXMLSchema, False)

def register_UnderlyingLegSecurityAltIDGrp_component(self):
    class NoUnderlyingLegSecurityAltIDGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.UnderlyingLegSecurityAltID, False)
            self.register_field(fields.UnderlyingLegSecurityAltIDSource, False)

    self.register_group(fields.NoUnderlyingLegSecurityAltID, NoUnderlyingLegSecurityAltIDGroup, False)

def register_UnderlyingLegInstrument_component(self):
    self.register_field(fields.UnderlyingLegSymbol, False)
    self.register_field(fields.UnderlyingLegSymbolSfx, False)
    self.register_field(fields.UnderlyingLegSecurityID, False)
    self.register_field(fields.UnderlyingLegSecurityIDSource, False)
    register_UnderlyingLegSecurityAltIDGrp_component(self)
    self.register_field(fields.UnderlyingLegCFICode, False)
    self.register_field(fields.UnderlyingLegSecurityType, False)
    self.register_field(fields.UnderlyingLegSecuritySubType, False)
    self.register_field(fields.UnderlyingLegMaturityMonthYear, False)
    self.register_field(fields.UnderlyingLegMaturityDate, False)
    self.register_field(fields.UnderlyingLegMaturityTime, False)
    self.register_field(fields.UnderlyingLegStrikePrice, False)
    self.register_field(fields.UnderlyingLegOptAttribute, False)
    self.register_field(fields.UnderlyingLegPutOrCall, False)
    self.register_field(fields.UnderlyingLegSecurityExchange, False)
    self.register_field(fields.UnderlyingLegSecurityDesc, False)

def register_TradeCapLegUnderlyingsGrp_component(self):
    class NoOfLegUnderlyingsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_UnderlyingLegInstrument_component(self)

    self.register_group(fields.NoOfLegUnderlyings, NoOfLegUnderlyingsGroup, False)

def register_UsernameGrp_component(self):
    class NoUsernamesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.Username, False)

    self.register_group(fields.NoUsernames, NoUsernamesGroup, False)

def register_NotAffectedOrdersGrp_component(self):
    class NoNotAffectedOrdersGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.NotAffOrigClOrdID, False)
            self.register_field(fields.NotAffectedOrderID, False)

    self.register_group(fields.NoNotAffectedOrders, NoNotAffectedOrdersGroup, False)

def register_FillsGrp_component(self):
    class NoFillsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.FillExecID, False)
            self.register_field(fields.FillPx, False)
            self.register_field(fields.FillQty, False)
            self.register_field(fields.FillLiquidityInd, False)
            register_NestedParties4_component(self)

    self.register_group(fields.NoFills, NoFillsGroup, False)

def register_TrdRepIndicatorsGrp_component(self):
    class NoTrdRepIndicatorsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.TrdRepPartyRole, False)
            self.register_field(fields.TrdRepIndicator, False)

    self.register_group(fields.NoTrdRepIndicators, NoTrdRepIndicatorsGroup, False)

def register_ApplicationSequenceControl_component(self):
    self.register_field(fields.ApplID, False)
    self.register_field(fields.ApplSeqNum, False)
    self.register_field(fields.ApplLastSeqNum, False)
    self.register_field(fields.ApplResendFlag, False)

def register_ApplIDRequestGrp_component(self):
    class NoApplIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.RefApplID, False)
            self.register_field(fields.RefApplReqID, False)
            self.register_field(fields.ApplBegSeqNum, False)
            self.register_field(fields.ApplEndSeqNum, False)
            register_NestedParties_component(self)

    self.register_group(fields.NoApplIDs, NoApplIDsGroup, False)

def register_ApplIDRequestAckGrp_component(self):
    class NoApplIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.RefApplID, False)
            ...
            self.register_field(fields.ApplBegSeqNum, False)
            self.register_field(fields.ApplEndSeqNum, False)
            self.register_field(fields.RefApplLastSeqNum, False)
            self.register_field(fields.ApplResponseError, False)
            register_NestedParties_component(self)

    self.register_group(fields.NoApplIDs, NoApplIDsGroup, False)

def register_ApplIDReportGrp_component(self):
    class NoApplIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.RefApplID, False)
            self.register_field(fields.ApplNewSeqNum, False)
            self.register_field(fields.RefApplLastSeqNum, False)

    self.register_group(fields.NoApplIDs, NoApplIDsGroup, False)

def register_NstdPtys4SubGrp_component(self):
    class NoNested4PartySubIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.Nested4PartySubID, False)
            self.register_field(fields.Nested4PartySubIDType, False)

    self.register_group(fields.NoNested4PartySubIDs, NoNested4PartySubIDsGroup, False)

def register_NestedParties4_component(self):
    class NoNested4PartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.Nested4PartyID, False)
            self.register_field(fields.Nested4PartyIDSource, False)
            self.register_field(fields.Nested4PartyRole, False)
            register_NstdPtys4SubGrp_component(self)

    self.register_group(fields.NoNested4PartyIDs, NoNested4PartyIDsGroup, False)

def register_TradeReportOrderDetail_component(self):
    self.register_field(fields.OrderID, False)
    self.register_field(fields.SecondaryOrderID, False)
    self.register_field(fields.ClOrdID, False)
    self.register_field(fields.SecondaryClOrdID, False)
    ...
    self.register_field(fields.RefOrderID, False)
    self.register_field(fields.RefOrderIDSource, False)
    self.register_field(fields.RefOrdIDReason, False)
    self.register_field(fields.OrdType, False)
    self.register_field(fields.Price, False)
    self.register_field(fields.StopPx, False)
    self.register_field(fields.ExecInst, False)
    ...
    register_OrderQtyData_component(self)
    self.register_field(fields.LeavesQty, False)
    ...
    self.register_field(fields.OrderRestrictions, False)
    self.register_field(fields.BookingType, False)
    self.register_field(fields.OrigCustOrderCapacity, False)
    self.register_field(fields.OrderInputDevice, False)
    self.register_field(fields.LotType, False)
    self.register_field(fields.TransBkdTime, False)
    self.register_field(fields.OrigOrdModTime, False)

def register_RateSource_component(self):
    class NoRateSourcesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.RateSource, False)
            self.register_field(fields.RateSourceType, False)
            self.register_field(fields.ReferencePage, False)

    self.register_group(fields.NoRateSources, NoRateSourcesGroup, False)

def register_TargetParties_component(self):
    class NoTargetPartyIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.TargetPartyID, False)
            self.register_field(fields.TargetPartyIDSource, False)
            self.register_field(fields.TargetPartyRole, False)

    self.register_group(fields.NoTargetPartyIDs, NoTargetPartyIDsGroup, False)

def register_NewsRefGrp_component(self):
    class NoNewsRefIDsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.NewsRefID, False)
            self.register_field(fields.NewsRefType, False)

    self.register_group(fields.NoNewsRefIDs, NoNewsRefIDsGroup, False)

def register_ComplexEvents_component(self):
    class NoComplexEventsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ComplexEventType, False)
            self.register_field(fields.ComplexOptPayoutAmount, False)
            self.register_field(fields.ComplexEventPrice, False)
            self.register_field(fields.ComplexEventPriceBoundaryMethod, False)
            self.register_field(fields.ComplexEventPriceBoundaryPrecision, False)
            self.register_field(fields.ComplexEventPriceTimeType, False)
            self.register_field(fields.ComplexEventCondition, False)
            register_ComplexEventDates_component(self)

    self.register_group(fields.NoComplexEvents, NoComplexEventsGroup, False)

def register_ComplexEventDates_component(self):
    class NoComplexEventDatesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ComplexEventStartDate, False)
            self.register_field(fields.ComplexEventEndDate, False)
            register_ComplexEventTimes_component(self)

    self.register_group(fields.NoComplexEventDates, NoComplexEventDatesGroup, False)

def register_ComplexEventTimes_component(self):
    class NoComplexEventTimesGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            self.register_field(fields.ComplexEventStartTime, False)
            self.register_field(fields.ComplexEventEndTime, False)

    self.register_group(fields.NoComplexEventTimes, NoComplexEventTimesGroup, False)

def register_StrmAsgnReqGrp_component(self):
    class NoAsgnReqsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_Parties_component(self)
            register_StrmAsgnReqInstrmtGrp_component(self)

    self.register_group(fields.NoAsgnReqs, NoAsgnReqsGroup, False)

def register_StrmAsgnRptGrp_component(self):
    class NoAsgnReqsGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_Parties_component(self)
            register_StrmAsgnRptInstrmtGrp_component(self)

    self.register_group(fields.NoAsgnReqs, NoAsgnReqsGroup, False)

def register_StrmAsgnReqInstrmtGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_Instrument_component(self)
...
def register_StrmAsgnRptInstrmtGrp_component(self):
    class NoRelatedSymGroup(fix_message.FIXGroup):
        def __init__(self):
            super().__init__()
            register_Instrument_component(self)
            self.register_field(fields.SettlType, False)
            self.register_field(fields.StreamAsgnType, False)
            self.register_field(fields.MDStreamID, False)
            self.register_field(fields.StreamAsgnRejReason, False)
            self.register_field(fields.Text, False)
            self.register_field(fields.EncodedTextLen, False)
            self.register_field(fields.EncodedText, False)
...
class Logout(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.SessionStatus, False)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
...
class IOI(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.Trailer = Trailer()
        super().__init__()
        register_ApplicationSequenceControl_component(self)
...
class ExecutionReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.TotNoFills, False)
        self.register_field(fields.LastFragment, False)
        register_FillsGrp_component(self)
        self.register_field(fields.GTBookingInst, False)
        self.register_field(fields.TradeDate, False)
        self.register_field(fields.TransactTime, False)
        ...
        register_MiscFeesGrp_component(self)
        self.register_field(fields.DividendYield, False)
        ...
        self.register_field(fields.Volatility, False)
        self.register_field(fields.TimeToExpiration, False)
        self.register_field(fields.RiskFreeRate, False)
        self.register_field(fields.PriceDelta, False)
...
class Logon(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.EncryptedPasswordMethod, False)
        self.register_field(fields.EncryptedPasswordLen, False)
        self.register_field(fields.EncryptedPassword, False)
        self.register_field(fields.EncryptedNewPasswordLen, False)
        self.register_field(fields.EncryptedNewPassword, False)
        self.register_field(fields.SessionStatus, False)
        self.register_field(fields.DefaultApplVerID, True)
        self.register_field(fields.DefaultApplExtID, False)
        self.register_field(fields.DefaultCstmApplVerID, False)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
...
class News(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        super().__init__()
        register_ApplicationSequenceControl_component(self)
        self.register_field(fields.NewsID, False)
        register_NewsRefGrp_component(self)
        self.register_field(fields.NewsCategory, False)
        self.register_field(fields.LanguageCode, False)
...
class NewOrderList(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.ContingencyType, False)
...
class ListStatus(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.ContingencyType, False)
        self.register_field(fields.ListRejectReason, False)
...
class QuoteRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.OrderCapacity, False)
        self.register_field(fields.OrderRestrictions, False)
        self.register_field(fields.PrivateQuote, False)
        self.register_field(fields.RespondentType, False)
        self.register_field(fields.PreTradeAnonymity, False)
        register_RootParties_component(self)
...
class Quote(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.QuoteMsgID, False)
        self.register_field(fields.QuoteRespID, False)
        self.register_field(fields.QuoteType, False)
        self.register_field(fields.PrivateQuote, False)
        register_QuotQualGrp_component(self)
...
class MarketDataSnapshotFullRefresh(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.MarketDepth, False)
        self.register_field(fields.MDFeedType, False)
        self.register_field(fields.RefreshIndicator, False)
        self.register_field(fields.TradeDate, False)
...
class QuoteCancel(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.QuoteResponseLevel, False)
        register_Parties_component(self)
        register_TargetParties_component(self)
        self.register_field(fields.Account, False)
        self.register_field(fields.AcctIDSource, False)
        self.register_field(fields.AccountType, False)
        self.register_field(fields.TradingSessionID, False)
...
class MassQuoteAcknowledgement(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.QuoteResponseLevel, False)
        self.register_field(fields.QuoteType, False)
        self.register_field(fields.QuoteCancelType, False)
        register_Parties_component(self)
        register_TargetParties_component(self)
        self.register_field(fields.Account, False)
        self.register_field(fields.AcctIDSource, False)
...
class SecurityStatus(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.UnsolicitedIndicator, False)
        self.register_field(fields.SecurityTradingStatus, False)
        self.register_field(fields.SecurityTradingEvent, False)
        self.register_field(fields.FinancialStatus, False)
        self.register_field(fields.CorporateAction, False)
        self.register_field(fields.HaltReason, False)
...
class TradingSessionStatus(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.UnsolicitedIndicator, False)
        self.register_field(fields.TradSesStatus, True)
        self.register_field(fields.TradSesEvent, False)
        self.register_field(fields.TradSesStatusRejReason, False)
        self.register_field(fields.TradSesStartTime, False)
        self.register_field(fields.TradSesOpenTime, False)
        self.register_field(fields.TradSesPreCloseTime, False)
...
class OrderMassCancelReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.SecondaryClOrdID, False)
        self.register_field(fields.OrderID, True)
        self.register_field(fields.MassActionReportID, True)
        self.register_field(fields.SecondaryOrderID, False)
        self.register_field(fields.MassCancelRequestType, True)
        ...
        register_NotAffectedOrdersGrp_component(self)
        self.register_field(fields.TradingSessionID, False)
        self.register_field(fields.TradingSessionSubID, False)
        register_Parties_component(self)
        register_TargetParties_component(self)
...
class SecurityListRequest(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.SecurityListID, False)
        self.register_field(fields.SecurityListType, False)
        self.register_field(fields.SecurityListTypeSource, False)
        self.register_field(fields.MarketID, False)
        self.register_field(fields.MarketSegmentID, False)
        register_Instrument_component(self)
        register_InstrumentExtension_component(self)
...
class SecurityList(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.ClearingBusinessDate, False)
        self.register_field(fields.SecurityListID, False)
        self.register_field(fields.SecurityListRefID, False)
        self.register_field(fields.SecurityListDesc, False)
        self.register_field(fields.EncodedSecurityListDescLen, False)
        self.register_field(fields.EncodedSecurityListDesc, False)
        self.register_field(fields.SecurityListType, False)
        self.register_field(fields.SecurityListTypeSource, False)
        self.register_field(fields.SecurityReqID, False)
        self.register_field(fields.SecurityResponseID, False)
...
class DerivativeSecurityList(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.ClearingBusinessDate, False)
        register_UnderlyingInstrument_component(self)
        register_DerivativeSecurityDefinition_component(self)
        self.register_field(fields.TransactTime, False)
        self.register_field(fields.TotNoRelatedSym, False)
        self.register_field(fields.LastFragment, False)
...
class TradeCaptureReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.VenueType, False)
        self.register_field(fields.MarketSegmentID, False)
        self.register_field(fields.MarketID, False)
        register_Instrument_component(self)
        register_FinancingDetails_component(self)
        ...
        self.register_field(fields.DividendYield, False)
        self.register_field(fields.RiskFreeRate, False)
        self.register_field(fields.CurrencyRatio, False)
        self.register_field(fields.CopyMsgIndicator, False)
        register_TrdRepIndicatorsGrp_component(self)
        self.register_field(fields.PublishTrdIndicator, False)
        self.register_field(fields.TradePublishIndicator, False)
        ...
        self.register_field(fields.GrossTradeAmt, False)
        self.register_field(fields.RejectText, False)
        self.register_field(fields.FeeMultiplier, False)
...
class PositionReport(fix_message.MessageBase):
    ...
    def __init__(self):
        ...
        self.register_field(fields.ModelType, False)
        self.register_field(fields.PriceDelta, False)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
...
class SettlementObligationReport(fix_message.MessageBase):
    _msgtype = 'BQ'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        ...
        register_ApplicationSequenceControl_component(self)
        self.register_field(fields.ClearingBusinessDate, False)
        self.register_field(fields.SettlementCycleNo, False)
        self.register_field(fields.SettlObligMsgID, True)
        self.register_field(fields.SettlObligMode, True)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
        self.register_field(fields.TransactTime, False)
        register_SettlObligationInstructions_component(self)


MESSAGE_TYPES['BQ'] = SettlementObligationReport

class DerivativeSecurityListUpdateReport(fix_message.MessageBase):
    _msgtype = 'BR'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        ...
        self.register_field(fields.TotNoRelatedSym, False)
        self.register_field(fields.LastFragment, False)
        register_RelSymDerivSecUpdGrp_component(self)


MESSAGE_TYPES['BR'] = DerivativeSecurityListUpdateReport

class TradingSessionListUpdateReport(fix_message.MessageBase):
    _msgtype = 'BS'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
...
MESSAGE_TYPES['BS'] = TradingSessionListUpdateReport

class MarketDefinitionRequest(fix_message.MessageBase):
    _msgtype = 'BT'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.MarketReqID, True)
        self.register_field(fields.SubscriptionRequestType, True)
        self.register_field(fields.MarketID, False)
        self.register_field(fields.MarketSegmentID, False)
        self.register_field(fields.ParentMktSegmID, False)


MESSAGE_TYPES['BT'] = MarketDefinitionRequest

class MarketDefinition(fix_message.MessageBase):
    _msgtype = 'BU'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        ...
        super().__init__()
        register_ApplicationSequenceControl_component(self)
        self.register_field(fields.MarketReportID, True)
        self.register_field(fields.MarketReqID, False)
        self.register_field(fields.MarketID, True)
        self.register_field(fields.MarketSegmentID, False)
        self.register_field(fields.MarketSegmentDesc, False)
        self.register_field(fields.EncodedMktSegmDescLen, False)
        self.register_field(fields.EncodedMktSegmDesc, False)
        self.register_field(fields.ParentMktSegmID, False)
        self.register_field(fields.Currency, False)
        register_BaseTradingRules_component(self)
        register_OrdTypeRules_component(self)
...
MESSAGE_TYPES['BU'] = MarketDefinition

class MarketDefinitionUpdateReport(fix_message.MessageBase):
    _msgtype = 'BV'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        ...
        self.register_field(fields.MarketReportID, True)
        self.register_field(fields.MarketReqID, False)
        self.register_field(fields.MarketUpdateAction, False)
        self.register_field(fields.MarketID, True)
        self.register_field(fields.MarketSegmentID, False)
        self.register_field(fields.MarketSegmentDesc, False)
        self.register_field(fields.EncodedMktSegmDescLen, False)
...
MESSAGE_TYPES['BV'] = MarketDefinitionUpdateReport

class UserNotification(fix_message.MessageBase):
    _msgtype = 'CB'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        register_UsernameGrp_component(self)
        self.register_field(fields.UserStatus, True)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)


MESSAGE_TYPES['CB'] = UserNotification

class OrderMassActionReport(fix_message.MessageBase):
    _msgtype = 'BZ'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        ...
        self.register_field(fields.SecondaryClOrdID, False)
        self.register_field(fields.MassActionReportID, True)
        self.register_field(fields.MassActionType, True)
        self.register_field(fields.MassActionScope, True)
        self.register_field(fields.MassActionResponse, True)
        self.register_field(fields.MassActionRejectReason, False)
        self.register_field(fields.TotalAffectedOrders, False)
        register_AffectedOrdGrp_component(self)
        register_NotAffectedOrdersGrp_component(self)
        self.register_field(fields.MarketID, False)
...
MESSAGE_TYPES['BZ'] = OrderMassActionReport

class OrderMassActionRequest(fix_message.MessageBase):
    _msgtype = 'CA'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
...
MESSAGE_TYPES['CA'] = OrderMassActionRequest

class ApplicationMessageRequest(fix_message.MessageBase):
    _msgtype = 'BW'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.ApplReqID, True)
        self.register_field(fields.ApplReqType, True)
        register_ApplIDRequestGrp_component(self)
        register_Parties_component(self)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
...
MESSAGE_TYPES['BW'] = ApplicationMessageRequest

class ApplicationMessageRequestAck(fix_message.MessageBase):
    _msgtype = 'BX'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.ApplResponseID, True)
        self.register_field(fields.ApplReqID, False)
        self.register_field(fields.ApplReqType, False)
        self.register_field(fields.ApplResponseType, False)
        self.register_field(fields.ApplTotalMessageCount, False)
        register_ApplIDRequestAckGrp_component(self)
        register_Parties_component(self)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)
...
MESSAGE_TYPES['BX'] = ApplicationMessageRequestAck

class ApplicationMessageReport(fix_message.MessageBase):
    _msgtype = 'BY'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.ApplReportID, True)
        self.register_field(fields.ApplReqID, False)
        self.register_field(fields.ApplReportType, True)
        register_ApplIDReportGrp_component(self)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
        self.register_field(fields.EncodedText, False)


MESSAGE_TYPES['BY'] = ApplicationMessageReport

class StreamAssignmentRequest(fix_message.MessageBase):
    _msgtype = 'CC'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.StreamAsgnReqID, True)
        self.register_field(fields.StreamAsgnReqType, True)
        register_StrmAsgnReqGrp_component(self)


MESSAGE_TYPES['CC'] = StreamAssignmentRequest

class StreamAssignmentReport(fix_message.MessageBase):
    _msgtype = 'CD'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.StreamAsgnRptID, True)
        self.register_field(fields.StreamAsgnReqType, False)
        self.register_field(fields.StreamAsgnReqID, False)
        register_StrmAsgnRptGrp_component(self)


MESSAGE_TYPES['CD'] = StreamAssignmentReport

class StreamAssignmentReportACK(fix_message.MessageBase):
    _msgtype = 'CE'
    _msgcat = 'app'
    def __init__(self):
        self.Header = Header()
        self.Trailer = Trailer()
        super().__init__()
        self.register_field(fields.StreamAsgnAckType, True)
        self.register_field(fields.StreamAsgnRptID, True)
        self.register_field(fields.StreamAsgnRejReason, False)
        self.register_field(fields.Text, False)
        self.register_field(fields.EncodedTextLen, False)
...
MESSAGE_TYPES['CE'] = StreamAssignmentReportACK
