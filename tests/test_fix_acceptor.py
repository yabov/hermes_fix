...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.settings.read_dict({self._testMethodName : {'ConnectionType' : 'acceptor',
                    ...
                    'StorageConnectionString' : ':memory:',
    ...
    def test_valid_logon_seq_high(self):
        ...
        def register_hack(session_name):
            self.client_app.register_callback(session_name, None, self.client_app.on_queue_msg)
    ...
    def test_invalid_comp_ID(self):
        ...
        client_bad = fix.SocketConnection(client_bad_app, self.store, settings_bad_client)
