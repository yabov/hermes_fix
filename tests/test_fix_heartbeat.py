...
class Test(unittest.TestCase):
    ...
    def test_msg_no_hb(self):
        ...
        future_out = asyncio.run_coroutine_threadsafe(self.server_app.engines[self._testMethodName].schedule_next_out_beat_await(
    ...
    def test_no_response_to_test_msg(self):
        ...
        self.server_app.engines[self._testMethodName].register_admin_callback(
            fix_messages_4_2_0_base.TestRequest, on_test_msg, CallbackRegistrar.CALLBACK_PRIORITY.NORMAL - 1)
